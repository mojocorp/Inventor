...
/// \sa SoNode,SoPath,SoPathList,SoCallbackAction,SoGLRenderAction,SoGetBoundingBoxAction,
/// \sa SoGetMatrixAction,SoHandleEventAction,SoPickAction,SoRayPickAction,SoSearchAction,SoWriteAction
