...
class INVENTOR_API SoFieldContainer : public SoBase {
  ...
  public:
    ...
    /// Returns TRUE if this object's fields are exactly equal to \a fc 's fields.
    /// If \a fc is not exactly same type as this object, FALSE is returned.
    SbBool		fieldsAreEqual(const SoFieldContainer *fc) const;

    /// Copies the contents of \a fc 's fields into this object's fields.  \a fc must
    /// be the same type as this object.  If \a copyConnections is TRUE, then if
    /// any of \a fc 's fields are connected then this object's fields will also
    ...
    /// #isDefault() bit is set will not be part of the string.  You can use the
    /// field->get() method to get a field's value as a string even if has its default value.
    ...
    /// Returns a pointer to the field of this object whose name is \a fieldName.
