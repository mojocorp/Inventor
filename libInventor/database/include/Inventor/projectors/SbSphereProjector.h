...
/// \sa SbLineProjector, SbPlaneProjector, SbSpherePlaneProjector,SbSphereSectionProjector, SbSphereSheetProjector
...
public:
    ...
    /// The passed \a point should be normalized (i.e. lie in the range [0.0,1.0]),
