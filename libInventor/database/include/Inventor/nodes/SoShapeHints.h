...
///
/// \par Action behavior:
/// <b>SoGLRenderAction, SoCallbackAction, SoRayPickAction, SoGetBoundingBoxAction</b>
...
class INVENTOR_API SoShapeHints : public SoNode {
  ...
  public:
    ...
    enum VertexOrdering {
        UNKNOWN_ORDERING = SoShapeHintsElement::UNKNOWN_ORDERING,   ///< Ordering of vertices is unknown
        CLOCKWISE        = SoShapeHintsElement::CLOCKWISE,          ///< Face vertices are ordered clockwise (from the outside)
        COUNTERCLOCKWISE = SoShapeHintsElement::COUNTERCLOCKWISE    ///< Face vertices are ordered counterclockwise (from the outside)
    };

    /// Hints about entire shape: if shape is known to be a solid
    /// object, as opposed to a surface.
    enum ShapeType {
        UNKNOWN_SHAPE_TYPE = SoShapeHintsElement::UNKNOWN_SHAPE_TYPE,   ///< Nothing is known about the shape
    ...
    /// or not.
    enum FaceType {
        UNKNOWN_FACE_TYPE = SoShapeHintsElement::UNKNOWN_FACE_TYPE, ///< Nothing is known about faces
