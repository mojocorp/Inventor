...
class INVENTOR_API SoSpotLight : public SoLight {
  ...
  public:
    ...
    SoSFVec3f	direction;	///< Principal direction of illumination (center axis of cone).
    SoSFFloat	dropOffRate;	///< Rate of intensity drop-off per change in angle from primary direction: 0 = constant intensity, 1 = very sharp drop-off
    SoSFFloat	cutOffAngle;	///< Angle (in radians) outside of which intensity is zero, measured from the center axis of the cone to an edge.
