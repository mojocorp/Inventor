...
class INVENTOR_API SoNormalBinding : public SoNode {
  ...
  public:
    enum Binding {
        OVERALL             = SoNormalBindingElement::OVERALL,            ///< Whole object has same normal
        PER_PART            = SoNormalBindingElement::PER_PART,           ///< One normal for each part of object
        PER_PART_INDEXED    = SoNormalBindingElement::PER_PART_INDEXED,   ///< One normal for each part of object, indexed
        PER_FACE            = SoNormalBindingElement::PER_FACE,           ///< One normal for each face of object
        PER_FACE_INDEXED    = SoNormalBindingElement::PER_FACE_INDEXED,   ///< One normal for each face, indexed
        PER_VERTEX          = SoNormalBindingElement::PER_VERTEX,         ///< One normal for each vertex of object
        PER_VERTEX_INDEXED  = SoNormalBindingElement::PER_VERTEX_INDEXED, ///< One normal for each vertex, indexed
    };
