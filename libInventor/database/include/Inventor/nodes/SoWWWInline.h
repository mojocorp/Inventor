...
/// It will render a wireframe bounding box as specified by the <b>bboxCenter</b>
/// and <b>bboxSize</b> fields, and the setting passed to <b>setBoundingBoxVisibility()</b>.
/// If no fetch URL callback is set and the <b>alternateRep</b>
/// is not NULL, the <b>alternateRep</b> will be rendered until child data has been set.
///
