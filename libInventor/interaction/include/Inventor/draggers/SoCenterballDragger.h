...
/// of the crosshairs.
/// The interface of the sphere and circles is just like <tt>SoTrackballDragger</tt>.
...
/// #center field is updated; there is no #translation field.
...
/// so pressing the <b><Shift></b> key allows you to constrain motion to slide along
/// either the local #x axis or #y axis of that crosshair..  The direction is determined by your initial
...
///
///
/// [a] Use an <tt>SoCenterballManip</tt>, which is subclassed from <tt>SoTransform</tt>.
/// The manipulator creates one of
/// these draggers and uses it as the interface to edit the manipulator's fields.
/// (See the <tt>SoCenterballManip</tt> man page.)
///
///
...
class INVENTOR_API SoCenterballDragger : public SoDragger {
  ...
  public:
    ...
    SoSFVec3f    center;    ///< Center of rotation and scale of the centerball dragger.
