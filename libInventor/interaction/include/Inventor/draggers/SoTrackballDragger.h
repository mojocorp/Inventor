...
///
///
/// [a] Use an <tt>SoTrackballManip</tt>, which is subclassed from <tt>SoTransform</tt>.
/// The manipulator creates one of
/// these draggers and uses it as the interface to edit the manipulator's fields.
/// (see the <tt>SoTrackballManip</tt> reference page).
///
///
...
/// \par Notes:
/// Unlike most multi-function draggers,  <tt>SoTrackballDragger</tt> is
...
/// <tt>SoCenterballDragger</tt> is similar in form to the trackball, but
...
/// \sa SoSpotLightDragger,SoTabBoxDragger,SoTabPlaneDragger,SoTransformBoxDragger,
