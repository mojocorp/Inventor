...
/// At the core of the jack is an <tt>SoDragPointDragger</tt> for translating the
/// jack.
///
///
...
/// The star is an <tt>SoRotateSphericalDragger</tt>, and dragging it updates the
/// #rotation field of the jack dragger.  The small cubes are  an
...
///
///
/// [a] Use an <tt>SoJackManip</tt>, which is subclassed from <tt>SoTransform</tt>.
/// It creates one of
/// these draggers and uses it as the interface to change its fields.
/// (see the <tt>SoJackManip</tt> man page).
///
///
...
/// \sa SoDragPointDragger,SoHandleBoxDragger,SoPointLightDragger,SoRotateCylindricalDragger,
...
/// \sa SoTabPlaneDragger,SoTrackballDragger,SoTransformBoxDragger,SoTransformerDragger,SoTranslate1Dragger,SoTranslate2Dragger
