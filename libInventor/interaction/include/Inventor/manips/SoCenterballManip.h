...
/// In this case, the interface edits the #rotation and #center fields.
///
///
...
///
///
/// The interface for an <tt>SoCenterballManip</tt> is exactly the same as that
/// of the <tt>SoCenterballDragger</tt>.
/// To find out more about the interface, see the reference page
/// for <tt>SoCenterballDragger</tt>.  To find out how the manipulator uses a
/// dragger to provide its interface, see the reference page for <tt>SoTransformManip</tt>.
///
///
...
/// (See the reference page for <tt>SoSurroundScale</tt>.)
///
...
/// }
/// \endcode
/// \sa SoCenterballDragger,SoHandleBoxManip,SoJackManip,SoTabBoxManip,SoTrackballManip,SoTransformBoxManip,SoTransformerManip,SoTransform,SoTransformManip
