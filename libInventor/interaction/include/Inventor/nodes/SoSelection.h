...
///
///
/// The selection can be highlighted automatically through the <tt>SoXtRenderArea</tt>,
...
/// }
/// \endcode
/// \sa SoEventCallback, SoXtRenderArea,SoBoxHighlightRenderAction, SoLineHighlightRenderAction
class INVENTOR_API SoSelection : public SoSeparator {
  ...
  public:
    ...
    /// Selection policy that is followed in response to user interaction. - default is SHIFT
    SoSFEnum		policy;
    //
    ...
    /// an \c SoPath with no nodes in it. (i.e. return new SoPath;)
    ...
    /// \c SoSelection will pick once on mouse down
