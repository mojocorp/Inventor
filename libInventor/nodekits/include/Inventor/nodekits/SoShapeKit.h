...
/// <tt>SoShapeKit</tt> is derived from <tt>SoSeparatorKit</tt> and <tt>SoBaseKit</tt>,
...
/// \sa SoNodeKitListPart,SoNodeKitPath,SoNodekitCatalog,SoSceneKit,SoSeparatorKit,
/// \sa SoWrapperKit,SoCone,SoCube,SoCylinder,SoIndexedNurbsCurve,SoIndexedNurbsSurface,
/// \sa SoNurbsCurve,SoNurbsSurface,SoShapeHints,SoSphere,SoText2,SoText3,SoVertexShape
