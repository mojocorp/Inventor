...
///
///
/// The <em>camera</em> part is created by default as an <tt>SoPerspectiveCamera</tt>
/// node, but may later be changed to any subclass of <tt>SoCamera</tt>.
///
///
...
///
///
/// <tt>SoCameraKit</tt> also adds a private part, <em>transformGroup</em>, which is
/// of type <tt>SoTransformSeparator</tt>. The kit uses this part to contain the
...
/// }
/// \endcode
/// \sa SoAppearanceKit,SoBaseKit,SoLightKit,SoNodeKit,SoNodeKitDetail,SoNodeKitListPart,SoNodeKitPath,SoNodekitCatalog,SoSceneKit,SoSeparatorKit,SoShapeKit,SoWrapperKit
