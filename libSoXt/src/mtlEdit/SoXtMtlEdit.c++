...
static char *deftitles[] = {"Material Ambient Color", "Material Diffuse Color",
...
static char *slider_defs[] = {
    "Amb: ", "Diff: ", "Spec: ", "Emis: ", "Shininess: ", "Transp: "};

static const float tileColors[][3] = {
    {.3, .3, .3}, {.6, .6, .6}, {.6, .6, .6}, {.3, .3, .3}};
static const float tileCoords[][3] = {{-3, 3, 0},  {0, 3, 0},  {3, 3, 0},
                                      {-3, 0, 0},  {0, 0, 0},  {3, 0, 0},
                                      {-3, -3, 0}, {0, -3, 0}, {3, -3, 0}};
...
//
SoXtMaterialEditor::SoXtMaterialEditor(Widget parent, const char *name,
...
////////////////////////////////////////////////////////////////////////
{
    ...
    XtAddCallback(pulldown, XmNmapCallback,
                  (XtCallbackProc)SoXtMaterialEditor::menuDisplay,
                  (XtPointer)this);
    ...
    n++;
    buttons[0] =
        XtCreateWidget("Edit", xmCascadeButtonGadgetClass, menubar, args, n);
...
#define TOGGLE_ITEM(NAME, KONST)                                               \
    menu1W[num1++] = menuItemsList[KONST] =                                    \
        XtCreateWidget(NAME, xmToggleButtonGadgetClass, pulldown, args, n);    \
...
#define PUSH_ITEM(NAME, KONST)                                                 \
    menu1W[num1++] = menuItemsList[KONST] =                                    \
        XtCreateWidget(NAME, xmPushButtonGadgetClass, pulldown, args, n);      \
    ...
    menu1W[num1++] =
        XtCreateWidget("separator", xmSeparatorGadgetClass, pulldown, NULL, 0);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // build sliders
    for (i = 0; i < 6; i++) {
        sliders[i] = new _SoXtColorSlider(form, NULL, TRUE,
...
#define ADD_SLIDER_CALLBACK(SLIDER, CB)                                        \
    SLIDER->addValueChangedCallback(&SoXtMaterialEditor::CB, this);
...
#undef ADD_SLIDER_CALLBACK
    ...
    for (i = 0; i < 4; i++) {
        diamondButtons[i] =
            XtCreateWidget("", xmToggleButtonGadgetClass, textForm, args, n);
        XtAddCallback(diamondButtons[i], XmNvalueChangedCallback,
                      (XtCallbackProc)SoXtMaterialEditor::diamondButtonPick,
    ...
    for (i = 0; i < 4; i++) {
        ...
        XtAddCallback(radioButtons[i], XmNvalueChangedCallback,
                      (XtCallbackProc)SoXtMaterialEditor::radioButtonPick,
                      (XtPointer)(unsigned long)i);
    }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
    n++;
    XtSetArg(args[n], XmNtopWidget, separatorW);
    n++;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    n++;
    acceptButton =
        XtCreateWidget("Accept", xmPushButtonGadgetClass, mgrWidget, args, n);
    ...
    n++;
    XtSetArg(args[n], XmNrightPosition, SCENE_RIGHT_POSITION);
    n++;
    ...
    XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
    n++;
    XtSetArg(args[n], XmNbottomOffset, 34);
    n++;
    ...
    n++;
    XtSetArg(args[n], XmNleftPosition, SCENE_RIGHT_POSITION / 2 - 7);
    n++;
    XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
    n++;
    XtSetArg(args[n], XmNrightPosition, SCENE_RIGHT_POSITION / 2 + 7);
    n++;
    XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
    n++;
    ...
    XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
    n++;
    XtSetArg(args[n], XmNleftPosition, SCENE_RIGHT_POSITION);
    n++;
...
//
void
SoXtMaterialEditor::colorEditorCB(void *userData, const SbColor *rgbColor)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
    SbColor             finalColor;
    SbBool              updateMaterial =
        (me->material != NULL && me->updateFreq == CONTINUOUS);
...
//
void
SoXtMaterialEditor::shininessSliderCB(void *userData, float value)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
...
//
void
SoXtMaterialEditor::transparencySliderCB(void *userData, float value)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
...
//
void
SoXtMaterialEditor::updateMaterialColor(SoMFColor *  editMtlColor,
                                        SoMFColor *  localMtlColor,
                                        const float *rgb, float intensity)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
SoXtMaterialEditor::ambientSliderCB(void *userData, float intensity)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
    ...
    me->updateMaterialColor(
        ...
        me->sliders[k_AMBIENT_ID]->getBaseColor(), intensity);
    me->changedIt[k_AMBIENT_ID] = TRUE;
}
...
//
void
SoXtMaterialEditor::diffuseSliderCB(void *userData, float intensity)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
    ...
    me->updateMaterialColor(
        ...
        me->sliders[k_DIFFUSE_ID]->getBaseColor(), intensity);
    me->changedIt[k_DIFFUSE_ID] = TRUE;
}
...
//
void
SoXtMaterialEditor::specularSliderCB(void *userData, float intensity)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
    ...
    me->updateMaterialColor(
        ...
        me->sliders[k_SPECULAR_ID]->getBaseColor(), intensity);
    me->changedIt[k_SPECULAR_ID] = TRUE;
}
...
//
void
SoXtMaterialEditor::emissiveSliderCB(void *userData, float intensity)
//
////////////////////////////////////////////////////////////////////////
{
    SoXtMaterialEditor *me = (SoXtMaterialEditor *)userData;
    ...
    me->updateMaterialColor(
        ...
        me->sliders[k_EMISSIVE_ID]->getBaseColor(), intensity);
    me->changedIt[k_EMISSIVE_ID] = TRUE;
}
...
//
void
SoXtMaterialEditor::updateColorSlider(_SoXtColorSlider *slider,
                                      const float       rgb[3])
//
////////////////////////////////////////////////////////////////////////
{
    ...
    // get color intensity
    max = (rgb[0] > rgb[1]) ? ((rgb[0] > rgb[2]) ? rgb[0] : rgb[2])
...
////////////////////////////////////////////////////////////////////////
{
    ...
    updateColorSlider(sliders[k_AMBIENT_ID],
                      localMaterial->ambientColor[0].getValue());
    updateColorSlider(sliders[k_DIFFUSE_ID],
                      localMaterial->diffuseColor[0].getValue());
    updateColorSlider(sliders[k_SPECULAR_ID],
                      localMaterial->specularColor[0].getValue());
    updateColorSlider(sliders[k_EMISSIVE_ID],
                      localMaterial->emissiveColor[0].getValue());
    ...
    if (activeColor == k_none) {
        ...
        if (colorEditor == NULL) {
            ...
            colorEditor = new _SoXtColorEditor(
                SoXt::getShellWidget(getWidget()), NULL, FALSE);
...
//
void
SoXtMaterialEditor::menuPick(Widget w, int id, XmAnyCallbackStruct *cb)
//
////////////////////////////////////////////////////////////////////////
{
    ...
    case k_MATERIAL_LIST:
        ...
        if (p->materialList == NULL) {
            p->materialList = new SoXtMaterialList(
                SoXt::getShellWidget(p->getWidget()), NULL, FALSE, mtlDir);
            p->materialList->addCallback(SoXtMaterialEditor::materialListCB, p);
    ...
    case k_EDIT_PASTE:
        ...
        p->clipboard->paste(eventTime, SoXtMaterialEditor::pasteDone, p);
        break;

    default:
#if DEBUG
        SoDebugError::post("SoXtMaterialEditor::menuPick", "id %d", id);
#endif
        break;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (XmToggleButtonGetState(w)) { // select only this slider
        ...
        switch (ID) {
        case k_AMBIENT_ID:
            p->activeColor = k_ambient;
            break;
        case k_DIFFUSE_ID:
            p->activeColor = k_diffuse;
            break;
        case k_SPECULAR_ID:
            p->activeColor = k_specular;
            break;
        case k_EMISSIVE_ID:
            p->activeColor = k_emissive;
            break;
        }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (XmToggleButtonGetState(w)) { // select this slider
        ...
        case k_ambient:
            TOGGLE_ON(p->diamondButtons[k_AMBIENT_ID]);
            break;
        case k_diffuse:
            TOGGLE_ON(p->diamondButtons[k_DIFFUSE_ID]);
            break;
        case k_specular:
            TOGGLE_ON(p->diamondButtons[k_SPECULAR_ID]);
            break;
        case k_emissive:
            TOGGLE_ON(p->diamondButtons[k_EMISSIVE_ID]);
            break;
        }
    }
...
//
void
SoXtMaterialEditor::materialListCB(void *me, const SoMaterial *mtl)
//
////////////////////////////////////////////////////////////////////////
{
