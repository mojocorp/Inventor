...
enum { X_PUSH = 0, Y_PUSH, Z_PUSH, CAM_PUSH, PUSH_NUM };
...
static char *     defaultLabel[] = {"Plane Viewer", "transX",
                               "transY",       "Plane Viewer Preference Sheet",
                               "Dolly",        "Zoom"};
...
//
SoXtPlaneViewer::SoXtPlaneViewer(Widget parent, const char *name,
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (display) {
        if (transCursor)
            XFreeCursor(display, transCursor);
        if (dollyCursor)
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (!xr.getResource("planeViewerPreferenceSheet",
                        "PlaneViewerPreferenceSheet",
                        rl.planeViewerPreferenceSheet))
...
////////////////////////////////////////////////////////////////////////
{
    ...
    for (int i = 0; i < PUSH_NUM; i++) {
        ...
        XtAddCallback(w, XmNactivateCallback,
                      (XtCallbackProc)SoXtPlaneViewer::pushButtonCB,
    ...
    buttonList[X_PUSH]->setIcon(so_xt_X_bits, so_xt_icon_width,
                                so_xt_icon_height);
    buttonList[Y_PUSH]->setIcon(so_xt_Y_bits, so_xt_icon_width,
                                so_xt_icon_height);
    buttonList[Z_PUSH]->setIcon(so_xt_Z_bits, so_xt_icon_width,
                                so_xt_icon_height);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    case MotionNotify:
        ...
        case PAN_MODE_ACTIVE:
            translateCamera(SbVec2f(me->x / float(raSize[0]),
...
SoXtPlaneViewer::pushButtonCB(Widget w, int id, void *) {
    ...
    switch (id) {
    case X_PUSH:
        v->setPlane(SbVec3f(1, 0, 0), SbVec3f(0, 0, -1));
        break;
    case Y_PUSH:
        v->setPlane(SbVec3f(0, 1, 0), SbVec3f(1, 0, 0));
        break;
    case Z_PUSH:
        v->setPlane(SbVec3f(0, 0, 1), SbVec3f(1, 0, 0));
        break;
    case CAM_PUSH:
        v->toggleCameraType();
        break;
