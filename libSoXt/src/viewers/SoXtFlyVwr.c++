 ...
 * Defines
 */
enum ViewerModes { STILL_MODE, FLY_MODE, TILT_MODE, SEEK_MODE, SET_UP_MODE };
...
static char *     defaultLabel[] = {"Fly Viewer", "Fly Viewer Preference Sheet",
                               "Flying speed:", " increase ", " decrease "};

////////////////////////////////////////////////////////////////////////
//
// Public constructor - build the widget right now
//
SoXtFlyViewer::SoXtFlyViewer(Widget parent, const char *name,
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (buildNow) {
        ...
        if (!xr.getResource("flyViewerPreferenceSheet",
                            "FlyViewerPreferenceSheet", rl.fvPrefSheet))
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (getDisplay()) {
        ...
        if (viewerCursor)
            XFreeCursor(display, viewerCursor);
        if (seekCursor)
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // viewing cursor
    source = XCreateBitmapFromData(display, d, so_xt_viewing_bits,
                                   so_xt_viewing_width, so_xt_viewing_height);
    viewerCursor =
        XCreatePixmapCursor(display, source, source, &foreground, &foreground,
                            so_xt_viewing_x_hot, so_xt_viewing_y_hot);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (maxStraightSpeed == 0)
        maxStraightSpeed =
            increase ? MIN_SPEED * speedLimit : -MIN_SPEED * speedLimit;
    else {
...
////////////////////////////////////////////////////////////////////////
{
    ...
    widgetList[0] =
        XtCreateWidget(rl.flyingSpeed, xmLabelGadgetClass, form, NULL, 0);
