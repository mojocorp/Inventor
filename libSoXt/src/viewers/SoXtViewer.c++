...
SoXtViewer::SoXtViewer(Widget parent, const char *name,
                       SbBool buildInsideParent, SoXtViewer::Type t,
                       SbBool buildNow)
...
////////////////////////////////////////////////////////////////////////
{
    ...
    autoClipBboxAction =
        new SoGetBoundingBoxAction(SbVec2s(1, 1)); // ??? no valid size yet
    ...
    seekAnimTime = 2.0;
    seekAnimationSensor =
        new SoFieldSensor(SoXtViewer::seekAnimationSensorCB, this);
...
////////////////////////////////////////////////////////////////////////
{
    if (type.isDerivedFrom(SoPerspectiveCamera::getClassTypeId()) ||
        ...
        SoDebugError::post("SoXtViewer::setCameraType", "unknown camera type!");
#endif
}
...
// Use: virtual public
SbBool
SoXtViewer::isStereoViewing() const
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: virtual public
void
SoXtViewer::setStereoType(StereoType type)
//
////////////////////////////////////////////////////////////////////////
{
    if (stereoType == type)
    ...
    case QUADBUFFER: {
        ...
        if (!isStereoBuffer()) {
            SoXt::createSimpleErrorDialog(
                baseWidget(), "Stereo Error",
                "Quadbuffer Stereo Viewing can't be set on this machine.");
            return;
        }
        break;
    }
...
SoXtViewer::getStereoType() const
//
////////////////////////////////////////////////////////////////////////
{
    return stereoType;
...
// Use: virtual public
void
SoXtViewer::setDrawStyle(SoXtViewer::DrawType type, SoXtViewer::DrawStyle style)
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    case VIEW_LOW_RES_POINT:
        // texture is always off under the switch node
        drawStyleNode->style =
            (style == VIEW_LINE || style == VIEW_LOW_RES_LINE)
                ? SoDrawStyle::LINES
                : SoDrawStyle::POINTS;
        drawStyleNode->style.setIgnored(FALSE);
        drawStyleNode->pointSize.setIgnored(style != VIEW_POINT &&
...
#ifdef DEBUG
        SoDebugError::post("SoXtViewer::setCurrentDrawStyle",
                           "VIEW_SAME_AS_STILL was passed !");
#endif
        break;
    }
...
////////////////////////////////////////////////////////////////////////
{
    setBufferingType(flag ? SoXtViewer::BUFFER_DOUBLE
...
////////////////////////////////////////////////////////////////////////
{
    ...
    //
        ...
        glDrawBuffer((isDoubleBuffer() && !drawToFrontBuffer) ? GL_BACK
                                                              : GL_FRONT);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbBool drawHiddenLine =
        (stillDrawStyle == VIEW_HIDDEN_LINE &&
         (!interactiveFlag || interactiveDrawStyle == VIEW_NO_TEXTURE ||
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (isDetailSeek()) {
        ...
        changeOrient.setValue(viewVector,
                              seekPoint - camera->position.getValue());
...
////////////////////////////////////////////////////////////////////////
{
    ...
    camera->orientation =
        SbRotation::slerp(oldCamOrientation, newCamOrientation, cos_t);

    // get camera new position
    camera->position =
        oldCamPosition + (newCamPosition - oldCamPosition) * cos_t;
}
...
#ifdef DEBUG
        SoDebugError::post("SoXtViewer::toggleCameraType",
                           "unknown camera type!");
#endif
        return;
    }
...
static float arrow_data[3][3] = {-ARROW_SIZE, 0,          0, 0, 2 * ARROW_SIZE,
                                 0,           ARROW_SIZE, 0, 0};
...
////////////////////////////////////////////////////////////////////////
{
    ...
    gluPartialDisk(quad, dist - 2, dist + LINE_THICK - 2, 20, 2,
                   cirAng - ANGLE_LEN, 2 * ANGLE_LEN);
    DARK_COLOR;
    gluDisk(quad, RADIUS + 1, RADIUS + LINE_THICK - 1, 20, 2);
    gluPartialDisk(quad, dist - 1, dist + LINE_THICK - 3, 20, 2,
                   cirAng - ANGLE_LEN, 2 * ANGLE_LEN);
