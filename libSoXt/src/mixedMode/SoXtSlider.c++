...
//
_SoXtSlider::_SoXtSlider(Widget parent, const char *name,
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (labelStr == NULL) {
        ...
        if (labelWidget == 0) {
            ...
            labelWidget = XtCreateWidget(labelStr, xmLabelGadgetClass,
                                         mgrWidget, NULL, 0);
    ...
    if (!numberVisible) {
        ...
        if (numberWidget == NULL) {
            ...
            XtAddCallback(numberWidget, XmNactivateCallback,
                          (XtCallbackProc)_SoXtSlider::textFieldCB,
                          (XtPointer)this);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    mouse->enable(getNormalWidget(), (XtEventHandler)SoXtGLWidget::eventHandler,
                  (XtPointer)this);
