...
//
_SoXtColorSlider::_SoXtColorSlider(Widget parent, const char *name,
                                   SbBool                 buildInsideParent,
                                   _SoXtColorSlider::Type type)
    : _SoXtSlider(parent, name, buildInsideParent,
...
_SoXtColorSlider::_SoXtColorSlider(Widget parent, const char *name,
                                   SbBool                 buildInsideParent,
                                   _SoXtColorSlider::Type type, SbBool buildNow)
    : _SoXtSlider(parent, name, buildInsideParent,
                  FALSE) // tell slider not to build just yet
//
////////////////////////////////////////////////////////////////////////
...
void
_SoXtColorSlider::setBaseColor(const float c[3])
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    case HUE_SLIDER: {
        ...
        float max = color[2];
        float min = (rgb[0] < rgb[1]) ? ((rgb[0] < rgb[2]) ? rgb[0] : rgb[2])
