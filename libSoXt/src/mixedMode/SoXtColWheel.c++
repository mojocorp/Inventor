...
//
_SoXtColorWheel::_SoXtColorWheel(Widget parent, const char *name,
                                 SbBool buildInsideParent)
    : SoXtGLWidget(parent, name, buildInsideParent, SO_GLX_RGB | SO_GLX_OVERLAY,
...
{
    mouse =
        new SoXtMouse(ButtonPressMask | ButtonMotionMask | ButtonReleaseMask);
...
void
_SoXtColorWheel::setBaseColor(const float hsv[3])
//
////////////////////////////////////////////////////////////////////////
{
...
////////////////////////////////////////////////////////////////////////
{
    ...
    mouse->enable(w, (XtEventHandler)SoXtGLWidget::eventHandler,
                  (XtPointer)this);
...
void
_SoXtColorWheel::makeWheelColors(SbColor *c, float intensity)
//
////////////////////////////////////////////////////////////////////////
{
    float hsv[3];
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (WYSIWYGmode && hsvColor[2] < 0.6) { // should be white
        if (blackMarker) {
            glXMakeCurrent(getDisplay(), getOverlayWindow(),
                           getOverlayContext());
...
//
void
_SoXtColorWheel::moveWheelMarker(short x,
                                 short y) // wheel center relative coordinates
//
////////////////////////////////////////////////////////////////////////
{
