...
//
MyThumbWheel::MyThumbWheel(Widget parent, const char *name,
                           SbBool buildInsideParent, SbBool horiz)
...
{
    mouse =
        new SoXtMouse(ButtonPressMask | ButtonReleaseMask | ButtonMotionMask);
    ...
    case MotionNotify:
        ...
        if (me->state & Button1Mask) {
            ...
            if (horizontal)
                ...
                r = (size[1] - me->y - lastPosition) /
                    float(size[1] - 2 * UI_THICK);
