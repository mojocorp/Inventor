...
class MyThumbWheel : public SoXtGLWidget {
  ...
  public:
    ...
    MyThumbWheel(Widget parent = NULL, const char *name = NULL,
                 SbBool buildInsideParent = TRUE, SbBool horizontal = TRUE);
    ~MyThumbWheel();
    ...
    //
    // Those routines are used to register callbacks for the different thumb
    // wheel actions.
    //
    ...
    //
    void addStartCallback(MyThumbWheelCB *f, void *userData = NULL);
    void addValueChangedCallback(MyThumbWheelCB *f, void *userData = NULL);
    void addFinishCallback(MyThumbWheelCB *f, void *userData = NULL);

    void removeStartCallback(MyThumbWheelCB *f, void *userData = NULL);
    void removeValueChangedCallback(MyThumbWheelCB *f, void *userData = NULL);
    void removeFinishCallback(MyThumbWheelCB *f, void *userData = NULL);
  ...
  protected:
    ...
    SoEXTENDER
    MyThumbWheel(Widget parent, const char *name, SbBool buildInsideParent,
                 SbBool horizontal, SbBool buildNow);
