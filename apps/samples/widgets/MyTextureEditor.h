...
class MyTextureEditor : public SoXtComponent {
  public:
    ...
    //
    MyTextureEditor(Widget parent = NULL, const char *name = NULL,
    ...
    const SoTexture2Transform *getTransformNode() const { return texXfNode; }
    ...
    //
    void addCallback(MyTextureEditorCB *f, void *userData = NULL) {
        callbackList.addCallback((SoCallbackListCB *)f, userData);
    }

    void removeCallback(MyTextureEditorCB *f, void *userData = NULL) {
  ...
  private:
    ...
    SbBool readScaledImage(char *fileName, int xsize, int ysize, char *buf,
                           int &zsize);
    ...
    static void deleteDialogCB(Widget, MyTextureEditor *,
                               XmAnyCallbackStruct *);
    ...
    static void fileDialogOkCB(Widget, MyTextureEditor *,
