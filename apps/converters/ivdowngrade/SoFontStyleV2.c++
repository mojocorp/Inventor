...
////////////////////////////////////////////////////////////////////////
{
    ...
    SoType::overrideType(SoFontStyle::getClassTypeId(),
                         &SoFontStyleV2::createInstance);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (out->getStage() == SoOutput::COUNT_REFS) {
        ...
        if (alternateRep.isDefault()) {
            ...
            // Inventor V2.0 cannot read unknown nodes with SoSFEnum or
            // SoSFBitMask fields. Don't let any enums get written out. NOTE: a
            // better solution might be to write the enum as a string, and have
            // the upgrader for this node convert that string back to an enum
            // value. But this bug was found too close to the 2.1 MR date to do
            // that more complicated fix. Instead, just don't write the enum.
