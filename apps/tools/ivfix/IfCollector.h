...
class IfCollector {
  ...
  public:
    ...
    int collect(SoNode *sceneRoot, IfShape *&shapeList, SbBool doTexCoords);
  ...
  private:
    ...
    storePathCB(void *userData, SoCallbackAction *cba, const SoNode *) {
        ((IfCollector *)userData)->storePath(cba);
        return SoCallbackAction::PRUNE;
    }

    static SoCallbackAction::Response
    storeNodeCB(void *userData, SoCallbackAction *cba, const SoNode *node) {
