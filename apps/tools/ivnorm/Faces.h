...
class FaceList : public SbPList {
  public:
    ...
    Face *operator[](int i) const { return (Face *)SbPList::operator[](i); }
    ...
    void              extractBody(int b, int &nFaces, int32_t *fNewFromOld,
                                  int32_t *fOldFromNew, int &nVertices, int32_t *vNewFromOld,
                                  int32_t *vOldFromNew);
