        ...
        : QMainWindow(parent, flags)
{
    ...
    m_p_viewer = new SoQtExaminerViewer();
    m_p_viewer->setObjectName("SoQtViewer");
    m_p_viewer->setGLRenderAction(new SoLineHighlightRenderAction());
    ...
    m_p_viewer->setSceneGraph(m_p_root);

    setCentralWidget(m_p_viewer->getWidget());
