...
XtResource intl_manip_resources[] = {
    ...
    },
    {
        ...
        XtRString,
        (XtPointer) "Centerball",
    },
    {
        "transformBoxMenuLabel",
        NULL,
        XtRString,
        sizeof(XtRString),
        (Cardinal)((char *)&manipData[5].name - (char *)&manipData[0]),
        XtRString,
        (XtPointer) "TransformBox",
    },
    {
        "tabBoxMenuLabel",
        NULL,
...
static SoSceneViewerButton viewData[] = {
    ...
    {0, 0, SV_SEPARATOR},
    {"Screen Door Transparency", SV_VIEW_SCREEN_TRANSPARENCY, SV_RADIO_BUTTON,
     0, 0},
...
XtResource intl_view_resources[] = {
    ...
    },
    {
        ...
        XtRString,
        (XtPointer) "Screen Door Transparency",
    },
    {
        "blendedMenuLabel",
        NULL,
    ...
    {
        "delayedBlendedMenuLabel",
        NULL,
        XtRString,
        sizeof(XtRString),
        (Cardinal)SV_OFFSET(&viewData[14].name, &viewData[0]),
        XtRString,
        (XtPointer) "Delayed Blended Transparency",
    },
    {
        "sortedBlendedMenuLabel",
        NULL,
        XtRString,
        sizeof(XtRString),
        (Cardinal)SV_OFFSET(&viewData[15].name, &viewData[0]),
        XtRString,
        (XtPointer) "Sorted Blended Transparency",
    },
    {
        "editBgColor",
        NULL,
        ...
        XtRString,
        (XtPointer) "Edit Background Color...",
    },
#else
    {
        "examinerMenuLabel",
