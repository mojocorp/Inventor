...
static NoodleButtonInfo fileData[] = {
    ...
    {"Save As...", MM_FILE_SAVE_AS, MM_PUSH_BUTTON, 0, "Alt Shift <Key> s",
     "Alt+S"},
    {"Save Standard Inventor...", MM_FILE_SAVE_VANILLA, MM_PUSH_BUTTON, 0,
     "Alt <Key> v", "Alt+v"},
...
static NoodleButtonInfo editData[] = {
    ...
    {"CopyAll", MM_EDIT_COPY_ALL, MM_PUSH_BUTTON, 0, "Alt Shift <Key> c",
     "Alt+C"},
};
...
static NoodleButtonInfo aboutData[] = {
    {"About Noodle...", MM_ABOUT_ABOUT, MM_PUSH_BUTTON, 0, "Alt <Key> h",
     "Alt+h"},
};
