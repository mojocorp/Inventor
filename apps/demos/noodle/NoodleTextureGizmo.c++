...
NoodleTextureGizmo::NoodleTextureGizmo(Widget parent, const char *name,
...
Widget
NoodleTextureGizmo::buildWidget(Widget parent) {
    Arg     resources[20];
    int     n = 0;
    SbVec2s sliderSize;
...
#define STRING(a) XmStringCreate(a, XmSTRING_DEFAULT_CHARSET)
    ...
    XtSetArg(resources[n], XmNlabelString, STRING("TextureOnOff"));
    ++n;
    textureToggle =
        XmCreateToggleButtonGadget(_rowCol, "textureOnOff", resources, n);
    n = 0;
    ...
    // Label...
    XtSetArg(resources[n], XmNlabelString, STRING("X repeat:"));
    ++n;
    Widget xRepeatLabel =
        XmCreateLabelGadget(_rowCol, "X repeat", resources, n);
    n = 0;
    XtManageChild(xRepeatLabel);
    // Slider...
    xRepeatSlider = new NoodleSlider(_rowCol);
    xRepeatSlider->addValueChangedCallback(NoodleTextureGizmo::xRepeatCallback,
                                           this);
    ...
    // Label...
    XtSetArg(resources[n], XmNlabelString, STRING("Y repeat:"));
    ++n;
    Widget yRepeatLabel =
        XmCreateLabelGadget(_rowCol, "Y repeat", resources, n);
    n = 0;
    XtManageChild(yRepeatLabel);
    // Slider...
    yRepeatSlider = new NoodleSlider(_rowCol);
    yRepeatSlider->addValueChangedCallback(NoodleTextureGizmo::yRepeatCallback,
                                           this);
    ...
    // Label...
    XtSetArg(resources[n], XmNlabelString, STRING("X transl:"));
    ++n;
    Widget xTranslLabel =
        XmCreateLabelGadget(_rowCol, "X transl", resources, n);
    n = 0;
    XtManageChild(xTranslLabel);
    // Slider...
    xTranslSlider = new NoodleSlider(_rowCol);
    xTranslSlider->addValueChangedCallback(NoodleTextureGizmo::xTranslCallback,
                                           this);
    ...
    // Label...
    XtSetArg(resources[n], XmNlabelString, STRING("Y transl:"));
    ++n;
    Widget yTranslLabel =
        XmCreateLabelGadget(_rowCol, "Y transl", resources, n);
    n = 0;
    XtManageChild(yTranslLabel);
    // Slider...
    yTranslSlider = new NoodleSlider(_rowCol);
    yTranslSlider->addValueChangedCallback(NoodleTextureGizmo::yTranslCallback,
                                           this);
    ...
    // Label...
    XtSetArg(resources[n], XmNlabelString, STRING("Rotation:"));
    ++n;
    Widget texRotationLabel =
        XmCreateLabelGadget(_rowCol, "Rotation", resources, n);
    n = 0;
    XtManageChild(texRotationLabel);
    // Slider...
    texRotationSlider = new NoodleSlider(_rowCol);
    texRotationSlider->addValueChangedCallback(
        NoodleTextureGizmo::texRotationCallback, this);
...
NoodleTextureGizmo::xTranslCallback(void *userData, void *) {
    ...
    if (myself->myNoodle != NULL) {
        SoTexture2Transform *txXf = SO_GET_PART(
            myself->myNoodle, "texture2Transform", SoTexture2Transform);
