...
class NoodleSlider : public SoXtComponent {
  public:
    NoodleSlider(Widget parent = NULL, const char *name = NULL,
                 SbBool buildInsideParent = TRUE, int startingMin = -1000,
    ...
    // internal:
    static void valueWidgetCallback(Widget w, void *client_data,
                                    void *call_data);
    static void sliderWidgetCallback(Widget w, void *client_data,
                                     void *call_data);
