...
class DisplayGraph {
  ...
  public:
    ...
    void setIconSpacing(const SbVec2f spacing) { iconSpacing = spacing; }
    ...
    SbBool getPasteLocation(float x, float y, GraphIcon *&parentIcon,
  ...
  private:
    ...
    void setNode(SoNode *node, GraphIcon *parentIcon, int iconIndex,
    ...
    static void checkIconState(GraphIcon *root, SbBool shouldBeHidden);
