...
static float vertexPositions[12][3] = {
    ...
    {-1.2142, 0.7453, 0.0000},  {-0.7453, 0.0000, 1.2142},
    {0.7453, 0.0000, 1.2142},   {1.2142, 0.7453, 0.0000},
...
static int32_t indices[72] = {
    ...
    0,  2, 7,  6, 4,  SO_END_FACE_INDEX, 0, 3, 6, 10, 5,  SO_END_FACE_INDEX,
    0,  4, 10, 9, 1,  SO_END_FACE_INDEX, 0, 5, 9, 8,  2,  SO_END_FACE_INDEX,

    9,  5, 4,  6, 11, SO_END_FACE_INDEX, // 5 faces about bottom
    10, 4, 3,  7, 11, SO_END_FACE_INDEX, 6, 3, 2, 8,  11, SO_END_FACE_INDEX,
    7,  2, 1,  9, 11, SO_END_FACE_INDEX, 8, 1, 5, 10, 11, SO_END_FACE_INDEX,

    6,  7, 8,  9, 10, SO_END_FACE_INDEX, // bottom face
};

// Colors for the 12 faces
static float colors[12][3] = {{1.0, .0, 0},  {.0, .0, 1.0}, {0, .7, .7},
                              {.0, 1.0, 0},  {.7, .7, 0},   {.7, .0, .7},
                              {0, .0, 1.0},  {.7, .0, .7},  {.7, .7, 0},
                              {.0, 1.0, .0}, {0, .7, .7},   {1.0, .0, 0}};
...
makeStellatedDodecahedron() {
    ...
    for (int i = 0; i < 12; i++)
        myVertexProperty->orderedRGBA.set1Value(
            i, SbColor(colors[i]).getPackedValue());
...
main(int argc, char **argv) {
    ...
    myVertexProperty =
        (SoVertexProperty *)myIndexedFaceSet->vertexProperty.getValue();
    ...
    case 1:
        ...
        // have the same color.
        myVertexProperty->materialBinding =
