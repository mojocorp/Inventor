...
JumpingJackKit::JumpingJackKit() {
    ...
    SO_KIT_ADD_CATALOG_ENTRY(body, SoShapeKit, TRUE, this, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(head, SoShapeKit, TRUE, this, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(leftArm, SoShapeKit, TRUE, this, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(rightArm, SoShapeKit, TRUE, this, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(leftLeg, SoShapeKit, TRUE, this, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(rightLeg, SoShapeKit, TRUE, this, \0, TRUE);
