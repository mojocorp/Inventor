...
Coordinate3Manip::Coordinate3Manip() {
    ...
    pointFieldSensor =
        new SoFieldSensor(&Coordinate3Manip::fieldSensorCB, this);
...
Coordinate3Manip::setDragger(SoDragger *newDragger) {
    ...
    if (newDragger) {
        ...
        newDragger->addValueChangedCallback(&Coordinate3Manip::valueChangedCB,
                                            this);
    }
}
...
Coordinate3Manip::copy(SbBool copyConnections) const {
    ...
    Coordinate3Manip *newManip =
        (Coordinate3Manip *)SoCoordinate3::copy(copyConnections);
