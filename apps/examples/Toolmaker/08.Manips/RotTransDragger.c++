...
RotTransDragger::RotTransDragger() {
    ...
    SO_KIT_ADD_CATALOG_ENTRY(translator, TranslateRadialDragger, TRUE,
                             topSeparator, geomSeparator, TRUE);

    SO_KIT_ADD_CATALOG_ENTRY(XRotatorSep, SoSeparator, FALSE, topSeparator,
                             geomSeparator, FALSE);
    SO_KIT_ADD_CATALOG_ENTRY(XRotatorRot, SoRotation, TRUE, XRotatorSep, \0,
                             FALSE);
    ...
    SO_KIT_ADD_CATALOG_ENTRY(ZRotatorSep, SoSeparator, FALSE, topSeparator,
                             geomSeparator, FALSE);
    SO_KIT_ADD_CATALOG_ENTRY(ZRotatorRot, SoRotation, TRUE, ZRotatorSep, \0,
                             FALSE);
    ...
    SoDragger *tDragger =
        SO_GET_ANY_PART(this, "translator", TranslateRadialDragger);
    ...
    translFieldSensor =
        new SoFieldSensor(&RotTransDragger::fieldSensorCB, this);
...
RotTransDragger::setUpConnections(SbBool onOff, SbBool doItAlways) {
    ...
    if (onOff) {
        ...
        tD->addFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                              this);
        ...
        XD->addFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                              this);
        ...
        YD->addFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                              this);
        ...
        ZD->addFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                              this);
        ...
        SoDragger *tD = (SoDragger *)getAnyPart("translator", FALSE);
        tD->removeStartCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                this);
        tD->removeFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                 this);
        unregisterChildDragger(tD);

        SoDragger *XD = (SoDragger *)getAnyPart("XRotator", FALSE);
        XD->removeStartCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                this);
        XD->removeFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                 this);
        unregisterChildDragger(XD);

        SoDragger *YD = (SoDragger *)getAnyPart("YRotator", FALSE);
        YD->removeStartCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                this);
        YD->removeFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                 this);
        unregisterChildDragger(YD);

        SoDragger *ZD = (SoDragger *)getAnyPart("ZRotator", FALSE);
        ZD->removeStartCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                this);
        ZD->removeFinishCallback(&RotTransDragger::invalidateSurroundScaleCB,
                                 this);
...
RotTransDragger::invalidateSurroundScaleCB(void *parent, SoDragger *) {
    ...
    SoSurroundScale *mySS =
        SO_CHECK_PART(myParentDragger, "surroundScale", SoSurroundScale);
    if (mySS != NULL)
        mySS->invalidate();
}
