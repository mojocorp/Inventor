...
////////////////////////////////////////////////////////////////////////
{
    ...
    // now run through the list looking for the device
    int i;
    for (i = 0; (i < numDevices) && (strcmp(list[i].name, DEVICE_NAME) != 0);
         i++)
        ; // keep looping
...
//
void
DialNButton::enable(Widget w, XtEventHandler proc, XtPointer clientData,
                    Window window)
//
////////////////////////////////////////////////////////////////////////
{
...
//
ButtonBoxEvent *
DialNButton::translateButtonEvent(XDeviceButtonEvent * be,
