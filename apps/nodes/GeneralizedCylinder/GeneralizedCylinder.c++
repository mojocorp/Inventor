...
////////////////////////////////////////////////////////////////////////
{
    ...
    SO_KIT_ADD_CATALOG_ENTRY(crossSectionCoords, SoCoordinate3, TRUE,
                             inputSwitch, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(spineCoords, SoCoordinate3, TRUE, inputSwitch, \0,
                             TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(twistCoords, SoCoordinate3, TRUE, inputSwitch, \0,
                             TRUE);
    ...
    SO_KIT_ADD_CATALOG_ENTRY(outputGrp, SoGroup, TRUE, topSeparator, childList,
                             FALSE);
    SO_KIT_ADD_CATALOG_ENTRY(shapeHints, SoShapeHints, TRUE, outputGrp, \0,
                             TRUE);
    ...
    SO_KIT_ADD_CATALOG_ENTRY(textureCoords, SoTextureCoordinate2, TRUE,
                             outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(texture2, SoTexture2, TRUE, outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(coords, SoCoordinate3, TRUE, outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(faceSet, SoFaceSet, TRUE, outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(quadMesh, SoQuadMesh, TRUE, outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(nurbsSurfaceGroup, SoGroup, TRUE, outputGrp, \0,
                             TRUE);
    ...
    SO_KIT_ADD_CATALOG_ENTRY(capTextureBinding, SoTextureCoordinateBinding,
                             TRUE, outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(capTextureCoords, SoTextureCoordinate2, TRUE,
                             outputGrp, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(topCapCoords, SoCoordinate3, TRUE, outputGrp, \0,
                             TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(topCapFaces, SoIndexedFaceSet, TRUE, outputGrp, \0,
                             TRUE);
...
GeneralizedCylinder::loadRow(int rowNum, SbVec3f *newCoords) {
    ...
    paramDist =
        (fullProfile->point[rowNum][1] - profileMinY) * profileOverHeight;
...
GeneralizedCylinder::getSpineInfo(float paramDist, SbVec3f &center,
    ...
    for (int i = 0; i < spinC->point.getNum() - 1; i++) {
        ...
        if (desiredDist >= lengthSoFar && desiredDist <= nextLength) {
            float fraction =
                (desiredDist - lengthSoFar) / (nextLength - lengthSoFar);
...
SbRotation
GeneralizedCylinder::getSpinePointRotation(int ind0, int ind1,
                                           float paramDist) {
...
GeneralizedCylinder::initSpineKeyPointRotations() {
    ...
    SbMatrix firstAnswerMat(
        rotatedX[0], rotatedX[1], rotatedX[2], 0, rotatedY[0], rotatedY[1],
        rotatedY[2], 0, rotatedZ[0], rotatedZ[1], rotatedZ[2], 0, 0, 0, 0, 1);
    ...
    for (int ind = 1; ind < lastInd; ind++) {
        ...
        SbMatrix answerMat(rotatedX[0], rotatedX[1], rotatedX[2], 0,
                           ...
                           rotatedZ[0], rotatedZ[1], rotatedZ[2], 0, 0, 0, 0,
                           1);
    ...
    if (spineClosed.getValue()) {
        ...
        SbMatrix lastAnswerMat(rotatedX[0], rotatedX[1], rotatedX[2], 0,
                               rotatedY[0], rotatedY[1], rotatedY[2], 0,
                               rotatedZ[0], rotatedZ[1], rotatedZ[2], 0, 0, 0,
                               0, 1);
...
GeneralizedCylinder::initUpdateInfo() {
    ...
    SoCoordinate3 *crosC =
        SO_GET_PART(this, "crossSectionCoords", SoCoordinate3);
    SoCoordinate3 *spinC = SO_GET_PART(this, "spineCoords", SoCoordinate3);
    SoCoordinate3 *twisC = SO_GET_PART(this, "twistCoords", SoCoordinate3);
...
GeneralizedCylinder::updateSurface() {
    ...
    SoIndexedFaceSet *topCapF =
        SO_GET_PART(this, "topCapFaces", SoIndexedFaceSet);
    SoCoordinate3 *botCapC =
        SO_GET_PART(this, "bottomCapCoords", SoCoordinate3);
    SoIndexedFaceSet *botCapF =
        SO_GET_PART(this, "bottomCapFaces", SoIndexedFaceSet);
    ...
    if (withTopCap.getValue() && crossSectionClosed.getValue() &&
        ...
        isSectionClockWise =
            Triangulator::clockWiseTest((*topC), (*topS), 0, topC->getNum());
    ...
    if (withBottomCap.getValue() && crossSectionClosed.getValue() &&
        ...
        SbBool isSectionClockWise;
        isSectionClockWise =
            Triangulator::clockWiseTest((*botC), (*botS), 0, botC->getNum());
...
GeneralizedCylinder::updateSurroundingManip() {
    ...
    SoSurroundScale *ss = (SoSurroundScale *)d->getPart("surroundScale", FALSE);
