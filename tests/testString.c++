...
TEST(SbString, Length) {
    ...
    EXPECT_EQ(6, sbstring.getLength());

    sbstring += SbString(" ") + SbString("test");

    EXPECT_EQ(11, sbstring.getLength());
}
...
TEST(SbString, getSubString) {
    SbString str("There are two needles in this haystack with needles.");
    EXPECT_STREQ("are two needles in this haystack with needles.",
                 str.getSubString(6).getString());
    EXPECT_STREQ("are two needles in this",
                 str.getSubString(6, 28).getString());
}
...
TEST(SbString, UTF8) {
    ...
    SbString string1 = SbString::fromUtf8(
        "Kl\303\274ft skr\303\244ms inf\303\266r p\303\245 "
        "f\303\251d\303\251ral \303\251lectoral gro\303\237e");
    SbString string2 =
        SbString::fromUtf8("Kl\303\274ft skr\303\244ms inf\303\266r ");
    SbString string3 = SbString::fromUtf8(
        "p\303\245 f\303\251d\303\251ral \303\251lectoral gro\303\237e");
    ...
    SbString string5("Kl\303\274ft skr\303\244ms inf\303\266r p\303\245 "
                     "f\303\251d\303\251ral \303\251lectoral gro\303\237e");
...
void
printstring(const SbString &str) {
...
TEST(SbString, WideChar) {
    ...
    SbString string5 = SbString::fromUtf8(
        "Kl\303\274ft skr\303\244ms inf\303\266r p\303\245 "
        "f\303\251d\303\251ral \303\251lectoral gro\303\237e");
    ...
    SbString string8 = SbString::fromUtf8(
        "\351\200\237\343\201\204\350\214\266\350\211\262\343\201\256\343\202"
        "\255\343\203\204\343\203\215\343\201\257\346\200\240\346\203\260\343"
        "\201\252\347\212\254\345\242\227\344\273\245\344\270\212");
