/**
 * Loader generated by glad 2.0.0-beta on Sat Mar 21 14:32:05 2020
 *
 * Generator: C/C++
 * Specification: wgl
 * Extensions: 2
 ...
 *
 * Commandline:
 *    --api='wgl=1.0' --extensions='WGL_ARB_extensions_string,WGL_EXT_extensions_string' c --on-demand --alias
 *
 * Online:
 *    http://glad.sh/#api=wgl%3D1.0&extensions=WGL_ARB_extensions_string%2CWGL_EXT_extensions_string&generator=c&options=ON_DEMAND%2CALIAS
 *
 */
...
#define GLAD_WGL
#define GLAD_OPTION_WGL_ON_DEMAND
...
GLAD_API_CALL void gladSetWGLOnDemandLoader(GLADloadfunc loader);
