/**
 * Loader generated by glad 2.0.0-beta on Sat Mar 21 14:32:04 2020
 *
 * Generator: C/C++
 * Specification: glx
 * Extensions: 0
 ...
 *
 * Commandline:
 *    --api='glx=1.4' --extensions='' c --on-demand --alias
 *
 * Online:
 *    http://glad.sh/#api=glx%3D1.4&extensions=&generator=c&options=ON_DEMAND%2CALIAS
 *
 */
...
#define GLAD_GLX
#define GLAD_OPTION_GLX_ON_DEMAND
...
GLAD_API_CALL void gladSetGLXOnDemandLoader(GLADloadfunc loader);
