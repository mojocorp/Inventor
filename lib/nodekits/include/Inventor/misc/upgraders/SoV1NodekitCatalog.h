...
class SoV1NodekitCatalogEntry {
  ...
  public:
    // constructor
    SoV1NodekitCatalogEntry(const SbName &theName, const SoType &theType,
...
class SoV1NodekitCatalog {
  ...
  public:
    ...
    // Adding entries
    SbBool addEntry(const SbName &theName, const SoType &theType,
                    const SoType &theDefaultType, const SbName &theParentName,
                    const SbName &theRightSiblingName, SbBool theListPart,
                    const SoType &theListItemType, SbBool thePublicPart);
  ...
  private:
    ...
    SbBool checkNewTypes(const SoType &theType, const SoType &theDefaultType);
