...
/// light, (<tt>SoLightKit</tt>), and object, (<tt>SoShapeKit</tt>, <tt>SoSeparatorKit</tt>,
/// and <tt>SoWrapperKit</tt>) nodekits into a scene.  A scene is composed
...
///
///
/// The <em>cameraList</em> part is a <em>list part</em> of <tt>SoCameraKit</tt> nodes.
/// The list itself is an <tt>SoNodeKitListPart</tt>, and since
/// only one camera can be active at a time, the
/// <em>container</em> of the <em>list part</em> is an <tt>SoSwitch</tt> node. Use
...
/// <tt>SoSeparatorKit</tt> in turn contains a <em>childList</em>, this part is used
/// to describe a hierarchical scene.
/// (See the reference page for <tt>SoSeparatorKit</tt>).
...
/// }
/// \endcode
/// \sa SoAppearanceKit,SoBaseKit,SoCameraKit,SoLightKit,SoNodeKit,SoNodeKitDetail,SoNodeKitListPart,SoNodeKitPath,SoNodekitCatalog,SoSeparatorKit,SoShapeKit,SoWrapperKit
