...
/// }
/// \endcode
/// \sa SoBaseKit,SoNodeKit,SoNodeKitDetail,SoNodeKitPath,SoNodekitCatalog,SoSceneKit,SoSeparatorKit,SoShapeKit,SoWrapperKit
class INVENTOR_API SoNodeKitListPart : public SoNode {
  ...
  public:
    ...
    /// the default of \c SoNode is overridden and only the
    ...
    /// node is an \c SoSwitch, for example.
    ...
    /// They parallel those of \c SoGroup, except that they always check
    /// the child types against those which are permissible.
    /// See \c SoGroup for details.
    /// @{
