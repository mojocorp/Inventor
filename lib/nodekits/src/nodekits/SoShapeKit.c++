...
////////////////////////////////////////////////////////////////////////
{
    ...
    SO_KIT_ADD_CATALOG_ENTRY(normalBinding, SoNormalBinding, TRUE, topSeparator,
                             childList, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(textureCoordinateBinding,
                             SoTextureCoordinateBinding, TRUE, topSeparator,
                             childList, TRUE);

    // Shapehints
    SO_KIT_ADD_CATALOG_ENTRY(shapeHints, SoShapeHints, TRUE, topSeparator,
                             childList, TRUE);

    // Coordinate and normal nodes
    SO_KIT_ADD_CATALOG_ENTRY(coordinate3, SoCoordinate3, TRUE, topSeparator,
                             childList, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(coordinate4, SoCoordinate4, TRUE, topSeparator,
                             childList, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(normal, SoNormal, TRUE, topSeparator, childList,
                             TRUE);
