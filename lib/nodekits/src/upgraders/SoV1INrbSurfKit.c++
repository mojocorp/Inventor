...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_NODE_IS_FIRST_INSTANCE()) {
        ...
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("profileCoordinate2",
                                       SoProfileCoordinate2, "topSeparator",
                                       "shape", TRUE);

        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("profileCoordinate3",
                                       SoProfileCoordinate3, "topSeparator",
                                       "shape", TRUE);
        ...
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY(
            "profileList", SoGroup, "topSeparator", "shape", SoProfile, TRUE);
