...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_NODE_IS_FIRST_INSTANCE()) {
        ...
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("pickStyle", SoPickStyle, "topSeparator",
                                       "", TRUE);

        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("appearance", SoAppearanceKit,
                                       "topSeparator", "", TRUE);

        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("transform", SoTransform, "topSeparator",
                                       "", TRUE);
        ...
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY(
            "childList", SoSeparator, "topSeparator", "", SoSeparatorKit, TRUE);
    }
...
//
{
    ...
    if (stompTranslate || stompRotation || stompScale || stompCenter) {
        SoDebugError::postWarning(
            "SoV1GroupKit::interpretCustomData",
            "texture2 contains texture transform fields. This kit also has a "
            "texture2Transform. The following fields  in texture2Transform "
            "will be overwritten:");
        if (stompTranslate)
