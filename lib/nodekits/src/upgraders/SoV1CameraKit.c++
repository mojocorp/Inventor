...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_NODE_IS_FIRST_INSTANCE()) {
        ...
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("appearance", SoAppearanceKit, "this",
                                       "", TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("transform", SoTransform, "this", "",
                                       TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_ABSTRACT_ENTRY(
            "camera", SoCamera, SoPerspectiveCamera, "this", "", TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY("childList", SoSeparator, "this",
                                            "", SoSeparatorKit, TRUE);
    }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (newPartName == "appearance" || newPartName == "childList") {
        ...
        SoDebugError::postWarning(
            "SoV1CameraKit::dealWithUpgradedPart",
