...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_NODE_IS_FIRST_INSTANCE()) {
        ...
        // through.
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("topSeparator", SoSeparator, "this", "",
                                       FALSE);
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY(
            "cameraList", SoSwitch, "topSeparator", "", SoCameraKit, TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY(
            "lightList", SoGroup, "topSeparator", "", SoLightKit, TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY(
            "childList", SoGroup, "topSeparator", "", SoSeparatorKit, TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY("manipulatorList", SoSeparator,
                                            "topSeparator", "",
                                            SoInteractionKit, TRUE);
    }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    grp = (SoGroup *)getAnyPart("cameraList", SoSwitch::getClassTypeId(), TRUE,
                                FALSE, FALSE);
    sw = (SoSwitch *)grp;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (newPartName == "manpulatorList") {
        ...
        SoDebugError::postWarning(
            "SoV1SceneKit::dealWithUpgradedPart",
            "the input file contained a part named %s. This part no longer "
            "exists, so you will unfortunately have to lose it.",
