...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_NODE_IS_FIRST_INSTANCE()) {
        ...
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("lightModel", SoLightModel, "this", "",
                                       TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("environment", SoEnvironment, "this", "",
                                       TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("drawStyle", SoDrawStyle, "this", "",
                                       TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("material", SoMaterial, "this", "",
                                       TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_ENTRY("complexity", SoComplexity, "this", "",
                                       TRUE);
        SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY("texture2List", SoGroup, "this", "",
                                            SoTexture2, TRUE);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (newPartName == "texture2List") {
        ...
        if (listGrp->getNumChildren() > 0) {
                    ...
                    for (int i = 0; i < tex2UpgdGrp->getNumChildren(); i++) {
                        ...
                        if (theKid->isOfType(SoTexture2::getClassTypeId())) {
                            ...
                            SoDebugError::postWarning(
                                "SoV1AppearanceKit::dealWithUpgradedPart",
                                "the input file contained a texture2 with "
                                "transform fields in it. Since the new "
                                "SoTexture2 does not contain these fields they "
                                "may be lost");
                        }
                        if (theKid->isOfType(
                                SoTexture2Transform::getClassTypeId())) {
            ...
            SoDebugError::postWarning(
                "SoV1AppearanceKit::dealWithUpgradedPart",
                "the input file contained a texture2List part. The new kits "
                "have only a texture2 part. Setting texture2 to be the first "
                "child in texture2List");
