...
class INVENTOR_API SoRotateCylindricalDragger : public SoDragger {
  ...
  public:
    ...
    /// <tt>SbCylinderProjector</tt> man pages to find out how each kind affects
    /// the feel of your dragger's motion. The default uses an
    ...
    /// dragger, based on the <b>y-axis</b> in local space and how far the
    /// initial mouse click occured from the center of rotation.
