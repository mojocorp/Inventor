...
/// width of the beam.
/// \ingroup Draggers
/// <tt>SoSpotLightDragger</tt> is a
/// composite dragger. It is shaped like a beam of light emanating from a
...
/// The arrow is an <tt>SoRotateSphericalDragger</tt> that controls the
/// #rotation field. See the reference page for
/// <tt>SoDirectionalLightDragger</tt>, which works the same way, for details.
///
///
...
/// <tt>SoDirectionalLightDragger</tt>  and <tt>SoPointLightDragger</tt> (which
/// goes into more detail).
///
///
/// <em>Remember:</em> This is <em>not</em> a light source! It just looks like
/// one. If you want to move a light with this dragger, you can do the
/// following:
///
///
/// [a] Use an <tt>SoSpotLightManip</tt>, which is subclassed from
/// <tt>SoLight</tt>. It creates an <tt>SoSpotLightDragger</tt> and uses it as
/// the interface to change the <b>location</b>, <b>direction</b>, and
/// <b>cutOffAngle</b> of its light source (see the <tt>SoSpotLightManip</tt>
/// man page). The manip also edits the <b>material</b> part of this dragger to
/// match the color of light the manip is producing.
///
///
/// [b] Connect the #angle field of this dragger to the <b>cutOffAngle</b>
