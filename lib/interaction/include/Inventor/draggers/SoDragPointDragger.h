...
/// Each pair has one <em>plane</em> dragger and one <em>line</em> dragger. The
/// line dragger is oriented perpendicular to the plane, so together the
/// <em>plane/line pair</em> lets you move through all of 3-space.
///
///
...
/// the <b>\<Control\></b> key with the cursor over the dragger. (You need not
...
/// <b>\<Shift\></b> key to constrain the motion of a plane dragger along one of
/// the two axes within the plane, as described in the
/// <tt>SoTranslate2Draggers</tt> man page.
///
///
/// DragPoint adds extra feedback parts to provide a more intuitive idea of
/// where you are placed in three-space. There are three <em>feedback
/// planes</em> and three <em>feedback axes</em>; each corresponds to one of the
/// plane or line draggers, but spans a much greater distance.  When you drag
/// along a line, that line's larger feedback axis is displayed, and remains
...
/// \endcode
/// \sa
/// SoInteractionKit,SoDragger,SoCenterballDragger,SoDragPointDragger,SoHandleBoxDragger,
/// \sa
