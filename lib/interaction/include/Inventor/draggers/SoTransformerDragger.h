...
/// Click and drag any face of the box for 2D translation in the plane of that
/// face. Drag any corner-cube to scale the box uniformly. Pick any of the
/// mid-face balls to rotate the whole dragger about its center.
///
///
/// The <tt>SoTransformerDragger</tt> uses locate highlighting, so you can tell
/// which part you are about to select before pressing the mouse button. By
/// default, the locate highlight color is gold.
///
///
/// Click-drag any <em>face</em> to translate the dragger within the plane of
/// that face.  The face you selected will highlight in yellow. While you drag,
/// yellow <em>feedback arrows</em> display the
/// two directions of motion.  Press the <b>\<Shift\></b> key and the arrows
/// turn orange; you may now pick between these two directions to
/// <em>constrain</em> the motion. The direction you move the cursor in will
/// determine which direction is chosen. Press the <b>\<Control\></b> key and
/// the dragger will translate <em>perpendicular</em> to that plane.  The
...
/// from the center of the box.  Drag radially and you will perform uniform
/// scale. Press the <b>\<Control\></b> key to scale about the opposite corner
/// instead of the center of the box.
///
///
/// To stretch the dragger non-uniformly, press <b>\<Shift\></b> when you drag
/// the corner cube.  Now you will see three orange arrows indicating that your
...
/// Pressing <b>\<Control\></b> at the same time as <b>\<Shift\></b> allows you
/// to stretch the dragger while keeping the opposite side pinned in place. When
...
///
///
/// To perform unconstrained ("free") rotation, just press <b>\<Shift\></b>
...
/// around. Regardless of how you rotate, dragging the spherical knobs will
/// modify the <b>rotation</b> field of the dragger. Depending on how it is
/// centered and what transforms precede it in the scene graph, rotation is
/// likely to affect the <b>translation</b> and <b>scaleFactor</b> fields as
/// well.
///
///
/// Pressing the <b>\<Control\></b> key will change the center of rotation in
/// both the constrained and unconstrained (<b>\<Shift\></b>) case.    By
/// default, rotation occurs about the center of the bounding box.  With
/// <b>\<Control\></b> depressed, rotation occurs about the middle of the
/// opposite side of the bounding box.  The purple feedback will change to
/// illustrate this; the feedback circles increase in size and purple crosshairs
/// sprout at the new rotational center.
///
///
/// Ordinarily, the knobs of the dragger are unsquished upon readin from file
/// and when the mouse button is released at the end of a drag. If you want this
/// to happen more often, then you should call the method #unsquishKnobs.
///
///
...
///
///
/// [a] Use an <tt>SoTransformerManip</tt>, which is subclassed from
/// <tt>SoTransform</tt>. It creates one of these draggers and uses it as the
/// interface to change its fields. (see the <tt>SoTransformerManip</tt> man
/// page).
///
///
...
/// \code CLASS SoTransformerDragger
/// -->"this"
///       "callbackList"
///       "topSeparator"
///          "motionMatrix"
...
/// \endcode
/// \sa
/// SoDragger,SoInteractionKit,SoLocateHighlight,SoCenterballDragger,SoDirectionalLightDragger,
/// \sa SoDragPointDragger,SoHandleBoxDragger,SoJackDragger,SoPointLightDragger,
/// \sa
/// SoRotateCylindricalDragger,SoRotateDiscDragger,SoRotateSphericalDragger,SoScale1Dragger,
/// \sa
...
class SoTransformerDragger : public SoDragger {
  ...
  public:
    ...
    /// Tells the dragger to unsquish its rotation and scale knobs during the
    /// next traversal. Ordinarily, the knobs are only unsquished upon readin
    /// from file and when the mouse button is released at the end of a drag. If
    /// you want this to happen more often, then you should call this method.
    void unsquishKnobs();
    ...
    /// are regarded as distinct.  If they are deemed "the same" then the
