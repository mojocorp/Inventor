...
///
/// The interface for an <tt>SoTabBoxManip</tt> is exactly the same as that
/// of the <tt>SoTabBoxDragger</tt>.
/// To find out more about the interface, see the reference page
/// for <tt>SoTabBoxDragger</tt>.  To find out how the manipulator uses a
...
/// }
/// \endcode
/// \sa SoCenterballManip,SoHandleBoxManip,SoJackManip,SoTabBoxDragger,SoTrackballManip,SoTransformBoxManip,SoTransformerManip,SoTransform,SoTransformManip
