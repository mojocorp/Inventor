...
///
/// As a subclass of <tt>SoTransformManip</tt>, this manip
/// also has a 3D interface to edit some of its fields.
/// In this case, the interface edits the #scaleFactor
...
///
/// The interface for an <tt>SoHandleBoxManip</tt> is exactly the same as that
/// of the <tt>SoHandleBoxDragger</tt>.
/// To find out more about the interface, see the reference page
/// for <tt>SoHandleBoxDragger</tt>.  To find out how the manipulator uses a
...
/// }
/// \endcode
/// \sa SoCenterballManip,SoHandleBoxDragger,SoJackManip,SoTabBoxManip,SoTrackballManip,SoTransformBoxManip,SoTransformerManip,SoTransform,SoTransformManip
