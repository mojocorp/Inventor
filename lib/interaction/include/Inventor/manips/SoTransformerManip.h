 ...
 *
 ...
 |      It uses a SoTransformerDragger to edit the fields of a
 hideableTransformManip
 |
...
/// translation.
/// \ingroup Manips
/// This is a new manipulator with some
/// improvements over the older inventor manips.  It has the following features:
/// [1] full interface for rotate, translate, and scale, [2] better feedback,
/// [3] locate highlighting.
///
...
class SoTransformerManip : public SoTransformManip {
  ...
  public:
    ...
    /// Tells the dragger inside this manip to unsquish its rotation and scale
    /// knobs during the next traversal. Ordinarily, the knobs are only
    /// unsquished upon readin from file and when the mouse button is released
    /// at the end of a drag. If you want this to happen more often, then you
