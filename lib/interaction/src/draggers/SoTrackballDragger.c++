...
#define ANIM_ADJUSTMENT                                                        \
    0.05 // used to schedule timerSensor to take
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (ctlDown)
        ...
        currentState = Z_ROTATE;
              ...
              pickPath->containsNode(userRotatorSwitch.getValue())) ||
    ...
    case FREE_ROTATE: {
        ...
        if (getFrontOnProjector() == USE_PICK)
            sphereProj->setFront(
                sphereProj->isPointInFront(startWorkSpaceHitPt));
    ...
    case USER_AXIS_ROTATE: {
        ...
        if (getFrontOnProjector() == USE_PICK)
            stripeProj->setFront(
                stripeProj->isPointInFront(startWorkSpaceHitPt));
        else if (getFrontOnProjector() == FRONT)
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbMatrix newMotionMatrix = appendRotation(
        prevMotionMatrix, deltaRot, SbVec3f(0, 0, 0), &workSpaceToLocal);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (computeAverage) {
        ...
        int num = (((lastIndex - firstIndex) + 1 + ROT_BUFFER_SIZE) %
                   ROT_BUFFER_SIZE);
