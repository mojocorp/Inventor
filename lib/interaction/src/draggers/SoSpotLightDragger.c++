...
////////////////////////////////////////////////////////////////////////
{
    SO__KIT_INIT_CLASS(SoSpotLightDragger, // class
...
SoSpotLightDragger::SoSpotLightDragger() {
    ...
    SO_KIT_ADD_CATALOG_ENTRY(translator, SoDragPointDragger, TRUE,
                             translatorSep, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(rotator, SoRotateSphericalDragger, TRUE,
                             topSeparator, geomSeparator, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(beamSep, SoSeparator, TRUE, topSeparator,
                             geomSeparator, FALSE);
    SO_KIT_ADD_CATALOG_ENTRY(beamPlacement, SoTranslation, TRUE, beamSep, \0,
                             TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(beamScale, SoScale, TRUE, beamSep, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(beamSwitch, SoSwitch, TRUE, beamSep, \0, FALSE);
    SO_KIT_ADD_CATALOG_ENTRY(beam, SoSeparator, TRUE, beamSwitch, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(beamActive, SoSeparator, TRUE, beamSwitch, \0,
                             TRUE);
    ...
    SoNode *resourceMtl = SoNode::getByName("spotLightOverallMaterial");
...
SoSpotLightDragger::setUpConnections(SbBool onOff, SbBool doItAlways) {
    ...
    if (onOff) {
        ...
        if (trD != NULL) {
            ...
            n = SoNode::getByName("spotLightTranslatorLineTranslatorActive");
            ...
            n = SoNode::getByName("spotLightTranslatorPlaneTranslatorActive");
        ...
        if (roD != NULL) {
            ...
            // Set up the parts in the child dragger
            roD->setPartAsDefault("rotator", "spotLightRotatorRotator");
            roD->setPartAsDefault("rotatorActive",
                                  "spotLightRotatorRotatorActive");
            roD->setPartAsDefault("feedback", "spotLightRotatorFeedback");
