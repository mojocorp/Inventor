...
////////////////////////////////////////////////////////////////////////
{
    SO__KIT_INIT_CLASS(SoJackDragger, // class
...
SoJackDragger::SoJackDragger() {
    ...
    SO_KIT_ADD_CATALOG_ENTRY(scaler, SoScaleUniformDragger, TRUE, topSeparator,
                             geomSeparator, TRUE);
    ...
    translFieldSensor = new SoFieldSensor(&SoJackDragger::fieldSensorCB, this);
    translFieldSensor->setPriority(0);

    // Updates the motionMatrix when the scaleFactor field is set.
    scaleFieldSensor = new SoFieldSensor(&SoJackDragger::fieldSensorCB, this);
...
SoJackDragger::setUpConnections(SbBool onOff, SbBool doItAlways) {
    ...
    if (onOff) {
        ...
        if (sD) {
            ...
            sD->addStartCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                 this);
            sD->addFinishCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                  this);
        ...
        if (rD) {
            ...
            rD->addStartCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                 this);
            rD->addFinishCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                  this);
        ...
        if (dD) {
            ...
            dD->addStartCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                 this);
            dD->addFinishCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                  this);
        ...
        SoDragger *sD = (SoDragger *)getAnyPart("scaler", FALSE);
        if (sD) {
            sD->removeStartCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                    this);
            sD->removeFinishCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                     this);
        ...
        SoDragger *rD = (SoDragger *)getAnyPart("rotator", FALSE);
        if (rD) {
            rD->removeStartCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                    this);
            rD->removeFinishCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                     this);
        ...
        if (dD) {
            ...
            dD->removeStartCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                    this);
            dD->removeFinishCallback(&SoJackDragger::invalidateSurroundScaleCB,
                                     this);
