...
////////////////////////////////////////////////////////////////////////
{
    ...
    // efficiently.
    SO_KIT_ADD_CATALOG_ENTRY(scalerSwitch, SoSwitch, TRUE, geomSeparator, \0,
                             FALSE);
    SO_KIT_ADD_CATALOG_ENTRY(scaler, SoSeparator, TRUE, scalerSwitch, \0, TRUE);
    SO_KIT_ADD_CATALOG_ENTRY(scalerActive, SoSeparator, TRUE, scalerSwitch, \0,
                             TRUE);
    ...
    if (SO_KIT_IS_FIRST_INSTANCE())
        readDefaultParts("scale2UniformDragger.iv", geomBuffer,
                         sizeof(geomBuffer));
    ...
    fieldSensor =
        new SoFieldSensor(&SoScale2UniformDragger::fieldSensorCB, this);
