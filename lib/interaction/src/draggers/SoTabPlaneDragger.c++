...
#undef TINY
    ...
    setMotionMatrix(
        appendScale(getStartMotionMatrix(), newScaling, scaleCenter));
}
...
#undef TINY
    ...
    setMotionMatrix(
        appendScale(getStartMotionMatrix(), scaleDelta, scaleCenter));
}
...
SoTabPlaneDragger::reallyAdjustScaleTabSize(SoGLRenderAction *action) {
    ...
    getXYScreenLengths(screenLengths, lclToScr,
