...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (SO_KIT_IS_FIRST_INSTANCE())
        readDefaultParts("rotateDiscDragger.iv", geomBuffer,
                         sizeof(geomBuffer));
    ...
    setPartAsDefault("rotatorActive", "rotateDiscRotatorActive");
    setPartAsDefault("feedback", "rotateDiscFeedback");
    setPartAsDefault("feedbackActive", "rotateDiscFeedbackActive");
    ...
    fieldSensor = new SoFieldSensor(&SoRotateDiscDragger::fieldSensorCB, this);
