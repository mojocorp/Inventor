...
SbTime::SbTime(time_t sec, long usec) { setValue(sec, usec); }
...
//
SbTime::SbTime(const struct timeval *tv) { setValue(tv); }
////////////////////////////////////////////////////////////////////////
//
// Description:
...
SbTime::operator-() const {
    return (tv_usec == 0) ? SbTime(-tv_sec, 0)
                          : SbTime(-tv_sec - 1, 1000000 - tv_usec);
}
...
////////////////////////////////////////////////////////////////////////
{
    SbTime tm(t0.tv_sec + t1.tv_sec, t0.tv_usec + t1.tv_usec);
...
SbBool
SbTime::operator<(const SbTime &tm) const {
    if ((tv_sec < tm.tv_sec) || (tv_sec == tm.tv_sec && tv_usec < tm.tv_usec))
        return TRUE;
    else
        return FALSE;
}
