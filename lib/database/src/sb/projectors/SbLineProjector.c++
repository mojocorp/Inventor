...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (viewVol.getProjectionType() == SbViewVolume::PERSPECTIVE) {
	    ...
	    fprintf(stderr,"checkDir = %f %f %f\n", test[0], test[1],test[2]);
            ...
            // defining points in screen space or the point will be undefined
            // when we cast it into world space. So clamp our selected point to
            // lie on vpPt1's side of the vanishing point.  Since points near
            // the vanishing point will also be incredibly far away, introduce
