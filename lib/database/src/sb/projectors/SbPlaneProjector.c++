...
SbPlaneProjector::SbPlaneProjector(const SbPlane &p, SbBool orient) {
    orientToEye = FALSE;
    setPlane(p);
    setOrientToEye(orient);
}
...
////////////////////////////////////////////////////////////////////////
{
    if (orientToEye) {
        ...
        SbVec3f planePoint = plane.getDistanceFromOrigin() * plane.getNormal();
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (viewVol.getProjectionType() == SbViewVolume::PERSPECTIVE &&
        ...
        float   denom =
            (normM[indexU] * normN[indexV]) + (normM[indexV] * normN[indexU]);
        slicePoint1[indexU] =
