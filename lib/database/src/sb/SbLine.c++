...
SbLine::SbLine(const SbVec3f &p0, const SbVec3f &p1) { setValue(p0, p1); }
...
SbBool
SbLine::getClosestPoints(const SbLine &line2, SbVec3f &ptOnThis,
    ...
    //          t * [ dir  . dir2 ] - s * [dir  . dir ] = dir  . pos - dir  .
    //          pos2 t * [ dir2 . dir2 ] - s * [dir2 . dir ] = dir2 . pos - dir2
    //          . pos2
    //      [4] Let:
    //          A= dir  . dir2
    //          B= dir  . dir
...
////////////////////////////////////////////////////////////////////////
{
    ...
    float   rad2 = (max - min).dot(max - min) * .25f;
    ...
    for (i = 0; i < 8; i++)
        points[i].setValue(i & 01 ? min[0] : max[0], i & 02 ? min[1] : max[1],
                           i & 04 ? min[2] : max[2]);
    ...
    for (i = 0; i < 12; i++) {
        ...
        if ((valid = intersect(points[v0], points[v1], points[v2], inter, bary,
                               front)) == TRUE) {
            if (front) {
                enter = inter;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (angle < 0.0)
        ...
        for (i = 0; i < 8; i++) {
            SbVec3f point(i & 01 ? min[0] : max[0], i & 02 ? min[1] : max[1],
                          i & 04 ? min[2] : max[2]);
...
SbBool
SbLine::intersect(float          pickAngle,   // The angle which makes the cone
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (getClosestPoints(inputLine, ptOnLine, intersection)) {
        ...
        validIntersection =
            ((distance / (ptOnLine - getPosition()).length()) < pickAngle);
    }
    return validIntersection;
}
