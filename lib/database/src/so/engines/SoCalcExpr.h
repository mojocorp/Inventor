...
class Expr {
  public:
    ...
    const char *typeName() { return type == FLOAT ? "float" : "Vec3f"; }
...
class Func_dd : public Func {
  public:
    Func_dd(const char *name, double (*f)(double, double))
...
class Func_id : public Func {
  public:
    Func_id(const char *name, double (*f)(int, double))
        : Func(name, FLOAT), func(f) {}
    ~Func_id();
    virtual Func *dup() const;
    virtual float getFloat();
...
class Func_v : public Func {
  public:
    Func_v(const char *name, double (*f)(const SbVec3f &))
        : Func(name, FLOAT), func(f) {}
    ~Func_v();
    virtual Func *dup() const;
    virtual float getFloat();
...
class Funcv_v : public Func {
  public:
    Funcv_v(const char *name, SbVec3f (*f)(const SbVec3f &))
        : Func(name, VEC3F), func(f) {}
    ~Funcv_v();
    virtual Func *  dup() const;
    virtual SbVec3f getVec3f();
    virtual void    setArgs(ExprList *args);
...
class Func_vv : public Func {
  public:
    Func_vv(const char *name, double (*f)(const SbVec3f &, const SbVec3f &))
        : Func(name, FLOAT), func(f) {}
    ~Func_vv();
    virtual Func *dup() const;
    virtual float getFloat();
...
class Funcv_vv : public Func {
  public:
    Funcv_vv(const char *name, SbVec3f (*f)(const SbVec3f &, const SbVec3f &))
        : Func(name, VEC3F), func(f) {}
    ~Funcv_vv();
    virtual Func *  dup() const;
    virtual SbVec3f getVec3f();
...
class Funcv_ddd : public Func {
  public:
    Funcv_ddd(const char *name, SbVec3f (*f)(double, double, double))
        : Func(name, VEC3F), func(f) {}
    ~Funcv_ddd();
    virtual Func *  dup() const;
    virtual SbVec3f getVec3f();
...
class Mult : public BinaryOp {
  public:
    Mult(Expr *a, Expr *b) : BinaryOp(a, b, FF | FV | VF) {
        type = a->type == b->type ? a->type : VEC3F;
    }
    ~Mult();
    virtual float   getFloat();
    virtual SbVec3f getVec3f();
