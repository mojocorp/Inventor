...
#ifdef DEBUG
    if (input != NULL) {
        SoDebugError::post("SoSelectOne::setup", "Already initialized!");
    }
#endif
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (whichIndex > input->getNum()) {
        SoDebugError::post("SoSelectOne::evaluate",
                           "Index (%d) out of range (0-%d)", whichIndex,
                           input->getNum());
    }
#endif
...
#define CASE(class)                                                            \
    case class:                                                                \
        ((SO__CONCAT(SoSF, class) *)outField)                                  \
            ->setValue((*((SO__CONCAT(SoMF, class) *)input))[whichIndex]);     \
        break
...
#ifdef DEBUG
            SoDebugError::post("SoSelectOne::evaluate", "conversionCase is %d!",
                               conversionCase);
#endif
            break;
        }
