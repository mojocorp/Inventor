...
SoTransparencyTypeElement::print(FILE *fp) const {
    ...
    switch (data) {
    case SCREEN_DOOR:
        fprintf(fp, "\tTransparency type = SCREEN_DOOR\n");
        break;
    case ADD:
        fprintf(fp, "\tTransparency type = ADD\n");
        break;
    case DELAYED_ADD:
        fprintf(fp, "\tTransparency type = DELAYED_ADD\n");
        break;
    case SORTED_OBJECT_ADD:
        fprintf(fp, "\tTransparency type = SORTED_OBJECT_ADD\n");
        break;
    case BLEND:
        fprintf(fp, "\tTransparency type = BLEND\n");
        break;
    case DELAYED_BLEND:
        fprintf(fp, "\tTransparency type = DELAYED_BLEND\n");
        break;
    case SORTED_OBJECT_BLEND:
        fprintf(fp, "\tTransparency type = SORTED_OBJECT_BLEND\n");
        break;
    default:
        fprintf(fp, "\tTransparency type = UNKNOWN\n");
        break;
    }
}
#else  /* DEBUG */
