...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (whatChanged != 0) {
        ...
        delayObjs = (sortObjs || transpType == DELAYED_ADD ||
    ...
    SoTransparencyTypeElement::set(
        state, (SoTransparencyTypeElement::TransparencyType)transpType);

    SoStereoElement::set(state, (SoStereoElement::StereoMode)stereoMode,
                         stereoOffset, stereoBalance);
