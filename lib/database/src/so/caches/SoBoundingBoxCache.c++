...
void
SoBoundingBoxCache::set(const SbXfBox3f &boundingBox, SbBool cSet,
...
////////////////////////////////////////////////////////////////////////
{
    ...
    const SoCacheElement *ce = (const SoCacheElement *)state->getConstElement(
        SoCacheElement::getClassStackIndex());
