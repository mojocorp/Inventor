...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (findEnumValue(name, enumVal))
        ...
        SoDebugError::post("SoMFEnum::setValue", "No enum for name \"%s\"",
                           name.getString());
#endif /* DEBUG */
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (findEnumValue(name, enumVal))
        ...
        SoDebugError::post("SoMFEnum::set1Value", "No enum for name \"%s\"",
                           name.getString());
#endif /* DEBUG */
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (legalValuesSet == TRUE) {
        SoDebugError::post("SoMFEnum::setEnums", "setEnums called twice");
    }
#endif
