...
//
// Description:
//    This initializes the SoIndexedPointSet class.
//
// Use: internal
...
////////////////////////////////////////////////////////////////////////
{
    SO__NODE_INIT_CLASS(SoIndexedPointSet, "IndexedPointSet", SoIndexedShape);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // called before state->pop() is called:
    {
        ...
        for (int i = 0; i < numPts; i++, fraction += delta) {
            ...
            if (materialPerPoint && i > 0 && numMat > curCoord)
                mb.send(materialIndex[curCoord], TRUE);
            if (normalPerPoint && numNorm > curCoord)
                ne->send(normalIndex[curCoord]);
            if (tcb.needCoordinates())
                tcb.send(coordIndex[curCoord]);

            // Send coordinate
            ce->send(coordIndex[curCoord]);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // called before state->pop() is called:
    {
        ...
        for (int i = 0; i < numPts; i++, fraction += delta) {
            ...
            pv.setPoint(ce->get3(coordIndex[curCoord]));
            detail.setCoordinateIndex(coordIndex[curCoord]);
            if (normalPerPoint) {
                pv.setNormal(ne->get(normalIndex[curCoord]));
                detail.setNormalIndex(normalIndex[curCoord]);
            }
            if (materialPerPoint) {
                pv.setMaterialIndex(materialIndex[curCoord]);
                detail.setMaterialIndex(materialIndex[curCoord]);
...
SbBool
SoIndexedPointSet::areMaterialsPerPoint(SoAction *action) const
//
////////////////////////////////////////////////////////////////////////
{
...
SbBool
SoIndexedPointSet::areNormalsPerPoint(SoAction *action) const
//
////////////////////////////////////////////////////////////////////////
{
