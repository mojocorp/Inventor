...
#define COMPUTE_S_T(point, s, t)                                               \
    s = std::atan2(point[0], point[2]) * .159f + .5f;                                \
    t = std::atan2(point[1], std::sqrt(point[0] * point[0] + point[2] * point[2])) *   \
            .318f +                                                             \
        .5f
...
void
SoSphere::GLRenderGeneric(SoGLRenderAction *action, SbBool sendNormals,
                          SbBool doTextures)
//
////////////////////////////////////////////////////////////////////////
{
