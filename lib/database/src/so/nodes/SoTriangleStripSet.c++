...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (vpCache.mightNeedSomethingFromState(shapeStyle)) {
        ...
        if (nstrips && numVertices[nstrips - 1] < 0) {
            ...
            numVertices.set1Value(nstrips - 1, vpCache.numVerts -
                                                   totalNumVertices -
                                                   startIndex.getValue());
...
void
SoTriangleStripSet::computeBBox(SoAction *action, SbBox3f &box, SbVec3f &center)
//
////////////////////////////////////////////////////////////////////////
{
    ...
    for (strip = 0; strip < numStrips; strip++) {
        ...
        for (int v = 0; v < vertsInStrip; v++) {
            if (v < 2) {
                ...
                n = nb->generator->getNormal(numTrisAtStartOfStrip * 3 + 2 +
                                             (v - 2) * 3);
                nb->generator->setNormal(vertexAtStartOfStrip + v, n);
            }
        }
