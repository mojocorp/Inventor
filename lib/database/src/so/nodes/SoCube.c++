...
void
SoCube::GLRenderGeneric(SoGLRenderAction *action, SbBool sendNormals,
                        SbBool doTextures)
//
////////////////////////////////////////////////////////////////////////
{
...
SoDetail *
SoCube::createTriangleDetail(SoRayPickAction *, const SoPrimitiveVertex *v1,
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SoModelMatrixElement::translateBy(action->getState(), this,
                                      bbox.getCenter());
    SoModelMatrixElement::scaleBy(action->getState(), this, 0.5 * size);
