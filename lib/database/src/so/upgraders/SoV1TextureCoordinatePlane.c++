...
////////////////////////////////////////////////////////////////////////
{
    SoTextureCoordinatePlane *tex =
        SO_UPGRADER_CREATE_NEW(SoTextureCoordinatePlane);
    tex->ref();
    ...
    float translation =
        distanceFromOrigin.getValue() / repeatInterval.getValue();
    ...
    if (coord.getValue() == ALL || coord.getValue() == T) {
        xf->translation = xf->translation.getValue() + SbVec2f(0, translation);
    }
    result->addChild(xf);
