...
#define SO__SF_ENUM_SET_TYPE(fieldName, enumType, contMacroName, contData)     \
    do {                                                                       \
        ...
        contData->getEnumData(SO__QUOTE(enumType), _so_sf_enum_num,            \
                              _so_sf_enum_vals, _so_sf_enum_names);            \
        SO__SF_ENUM_CHECK_DATA(_so_sf_enum_vals, SO__QUOTE(enumType),          \
                               SO__QUOTE(fieldName), contMacroName);           \
        fieldName.setEnums(_so_sf_enum_num, _so_sf_enum_vals,                  \
                           _so_sf_enum_names);                                 \
    } while (0)
