...
///
/// is an SoSFEngine field named 'mySoSFEngineField', pointing to an SoElapsedTime engine.
/// If the engine is used elsewhere, the regular DEF/USE instancing mechanism applies:
///
...
/// \sa SoField, SoSField, SoMFEngine, SoEngine
