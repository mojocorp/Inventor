...
/// Multiple-value field containing any number of RGB colors stored as three
/// floats.
/// \ingroup Fields
/// A multiple-value field that contains any number of
/// RGB colors, stored as instances of <tt>SbColor</tt>.  Values may be set in
/// either RGB (red, green, blue) or HSV (hue, saturation, value) color spaces.
///
