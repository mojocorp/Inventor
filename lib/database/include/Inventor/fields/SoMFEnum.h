...
///
/// <tt>SoMFEnums</tt> are written to file as a set of
...
class SoMFEnum : public SoMField {
  ...
  public:
    ...
    /// Sets the \a index 'th value to be the integer corresponding to the
...
#define SO__MF_ENUM_SET_TYPE(fieldName, enumType, contMacroName, contData)     \
    do {                                                                       \
        ...
        contData->getEnumData(SO__QUOTE(enumType), _so_mf_enum_num,            \
                              _so_mf_enum_vals, _so_mf_enum_names);            \
        SO__MF_ENUM_CHECK_DATA(_so_mf_enum_vals, SO__QUOTE(enumType),          \
                               SO__QUOTE(fieldName), contMacroName);           \
        fieldName.setEnums(_so_mf_enum_num, _so_mf_enum_vals,                  \
                           _so_mf_enum_names);                                 \
    } while (0)
