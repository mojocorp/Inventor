...
/// \ingroup Engines
/// <tt>SoInterpolate</tt> is the abstract base class for all interpolator engines.
/// An interpolator engine linearly interpolates between two values, based
/// on the #alpha input value.  The #alpha value should
...
/// \sa SoEngineOutput, SoInterpolateFloat, SoInterpolateRotation,SoInterpolateVec2f, SoInterpolateVec3f, SoInterpolateVec4f
