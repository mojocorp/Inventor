...
#define SO_SPACEBALL_PRESS_EVENT(EVENT, BUTTON)                                \
    (SoSpaceballButtonEvent::isButtonPressEvent(                               \
        EVENT, SoSpaceballButtonEvent::BUTTON))
...
/// \ingroup Events
/// <tt>SoSpaceballButtonEvent</tt> represents spaceball button press and
...
class SoSpaceballButtonEvent : public SoButtonEvent {
  ...
  public:
    ...
    /// Set which spaceball button generated the event., e.g.
    /// SoSpaceballButtonEvent::BUTTON1
    void setButton(SoSpaceballButtonEvent::Button b) { button = b; }

    /// Get which spaceball button generated the event., e.g.
    /// SoSpaceballButtonEvent::BUTTON1
    SoSpaceballButtonEvent::Button getButton() const { return button; }
    ...
    static SbBool
    isButtonPressEvent(const SoEvent *                e,
    ...
    /// or release of any spaceball button.
    static SbBool
    isButtonReleaseEvent(const SoEvent *                e,
                         SoSpaceballButtonEvent::Button whichButton);
