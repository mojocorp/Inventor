...
class INVENTOR_API SoLineDetail : public SoDetail {
  ...
  public:
    ...
    /// These return information about the first of two points forming the end
    /// vertices of the line segment, represented as an \a SoPointDetail.
    const SoPointDetail *getPoint0() const { return &point[0]; }

    /// These return information about the second of two points forming the end
    /// vertices of the line segment, represented as an \a SoPointDetail.
