...
/// \sa SbCylinderPlaneProjector,SbCylinderSheetProjector,SbLineProjector,
/// SbPlaneProjector, \sa SbSpherePlaneProjector,SbSphereProjector,
...
class SbCylinderSectionProjector : public SbCylinderProjector {
  public:
    ...
    /// The default cylinder is centered about the Y axis and has a radius
    /// of 1.0. The default edge tolerance is .9. The default eye orientation is
    /// TRUE.
    ...
    SbCylinderSectionProjector(const SbCylinder &cyl, float edgeTol = .9f,
