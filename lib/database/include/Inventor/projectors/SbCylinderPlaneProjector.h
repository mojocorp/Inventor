...
/// \sa SbCylinderSheetProjector,SbLineProjector, SbPlaneProjector,
...
class SbCylinderPlaneProjector : public SbCylinderSectionProjector {
  public:
    ...
    /// The position of the plane is specified as a fraction of the cylinder
    ...
    /// outside edge of the cylinder.  The default value is .9, so that almost
