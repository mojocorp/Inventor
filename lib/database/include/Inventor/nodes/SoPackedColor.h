...
/// \ingroup Nodes
/// <tt>SoPackedColor</tt> is similar to <tt>SoBaseColor</tt> in that it sets
/// the diffuse color component of the current material. However, it also
...
class SoPackedColor : public SoNode {
  ...
  public:
    ...
    SbBool       isTransparent() const { return transparent; }
