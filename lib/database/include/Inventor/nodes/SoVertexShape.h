...
/// <tt>SoFaceSet</tt> or <tt>SoTriangleStripSet</tt>), an <tt>SoFaceDetail</tt> is
...
/// composed of points (such as <tt>SoPointSet</tt>), an <tt>SoPointDetail</tt> is
...
/// \sa SoIndexedShape, SoNonIndexedShape, SoVertexProperty
