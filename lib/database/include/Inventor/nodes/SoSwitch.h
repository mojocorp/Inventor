...
/// from certain other nodes (such as <tt>SoArray</tt> or
/// <tt>SoMultipleCopy</tt>) that set the switch value. A value of
/// <b>SO_SWITCH_ALL</b> (-3) traverses all children, making the switch behave
/// exactly like a regular <tt>SoGroup</tt>.
///
/// \par Action behavior:
...
class INVENTOR_API SoSwitch : public SoGroup {
  ...
  public:
    // Fields
    SoSFInt32
        whichChild; ///< Index of the child to traverse, or one of
                    ///< SO_SWITCH_NONE, SO_SWITCH_INHERIT, or SO_SWITCH_ALL.
