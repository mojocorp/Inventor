...
/// browser like the HTML based <b>Netscape Navigator</b> or the VRML based <b>WebSpace Navigator</b>
/// to load the URL.
///
/// \par Action behavior:
...
class INVENTOR_API SoWWWAnchor : public SoLocateHighlight {
  ...
  public:
    ...
    /// set to <b>POINT</b>, then the x,y,z location of the object space intersection
