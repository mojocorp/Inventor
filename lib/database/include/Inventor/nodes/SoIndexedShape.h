...
/// <b>PER_PART_INDEXED</b>	Same as <b>PER_PART</b>, using indices from the
/// #materialIndex or #normalIndex field.
/// <b>PER_FACE</b>		Specific to the subclass.
/// <b>PER_FACE_INDEXED</b>	Same as <b>PER_FACE</b>, using indices from the
/// #materialIndex or #normalIndex field. <b>PER_VERTEX</b>		One
/// material per vertex. <b>PER_VERTEX_INDEXED</b>	One material per vertex,
/// using indices from the #materialIndex or #normalIndex field. \endcode
///
...
class SoIndexedShape : public SoVertexShape {
  ...
  protected:
    ...
    void setupIndices(int numParts, int numFaces, SbBool needNormals,
