...
/// <b>SO_END_STRIP_INDEX (-1)</b> indicates that the current strip has ended
...
/// \endcode
/// \sa
/// SoCoordinate3,SoDrawStyle,SoFaceDetail,SoIndexedFaceSet,SoTriangleStripSet,SoVertexProperty
