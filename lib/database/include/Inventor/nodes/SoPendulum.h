...
/// \ingroup Nodes
/// The <tt>SoPendulum</tt> class is derived from <tt>SoRotation</tt>, so it
...
/// SoRayPickAction</b> Concatenates interpolated rotation value with the
/// current transformation matrix. <b>SoGetMatrixAction</b> Returns
/// transformation matrix specified by the interpolated rotation.
///
...
class SoPendulum : public SoRotation {
  ...
  public:
    // Fields
    SoSFRotation rotation0; ///< These define the two fixed rotations that are
                            ///< interpolated to create the pendular motion.
    SoSFRotation rotation1; ///< These define the two fixed rotations that are
                            ///< interpolated to create the pendular motion.
    SoSFFloat
        speed; ///< Defines the speed of the pendulum, in cycles per second.
    SoSFBool
