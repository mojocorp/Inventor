...
/// If the number of diffuse colors in the state is less than the number
/// required for the given binding, a debug warning will be printed and
/// unpredictable colors will result.
///
/// \par Action behavior:
  ...
  public:
    enum Binding {
        OVERALL = SoMaterialBindingElement::OVERALL, ///< Whole object has same
                                                     ///< material
        PER_PART = SoMaterialBindingElement::PER_PART, ///< One material for
                                                       ///< each part of object
        PER_PART_INDEXED =
            SoMaterialBindingElement::PER_PART_INDEXED, ///< One material for
                                                        ///< each part of
                                                        ///< object, indexed
        PER_FACE = SoMaterialBindingElement::PER_FACE,  ///< One material for
                                                        ///< each face of object
        PER_FACE_INDEXED =
            SoMaterialBindingElement::PER_FACE_INDEXED, ///< One material for
                                                        ///< each face, indexed
        PER_VERTEX =
            SoMaterialBindingElement::PER_VERTEX, ///< One material for each
                                                  ///< vertex of object
        PER_VERTEX_INDEXED =
            SoMaterialBindingElement::PER_VERTEX_INDEXED, ///< One material for
                                                          ///< each vertex,
                                                          ///< indexed
    };
