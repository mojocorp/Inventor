...
class SoNodeList : public SoBaseList {
  public:
    ...
    void append(SoNode *ptr) { ((SoBaseList *)this)->append((SoBase *)ptr); }
...
class SoEngineList : public SoBaseList {
  public:
    ...
    void append(SoEngine *ptr) { ((SoBaseList *)this)->append((SoBase *)ptr); }
...
class SoDetailList : public SbPList {
  public:
    ...
    void append(SoDetail *detail) { SbPList::append((void *)detail); }
...
class SoFieldList : public SbPList {
  public:
    ...
    void append(SoField *field) { SbPList::append((void *)field); }
