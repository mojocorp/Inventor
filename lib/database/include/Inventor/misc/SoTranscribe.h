...
class INVENTOR_API SoTranSender {
  public:
    ...
    /// The constructor takes a pointer to an \c SoOutput instance that
    ...
    /// Returns pointer to current \c SoOutput instance.
    ...
    /// Prepares a \c SoTranSender instance for transcription, making sure
...
class INVENTOR_API SoTranReceiver {
  ...
  public:
    ...
    /// references) are recoverable, while others (such as syntax errors) are not.
