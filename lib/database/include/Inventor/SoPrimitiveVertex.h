...
/// \ingroup General
/// An <tt>SoPrimitiveVertex</tt> represents a vertex of a primitive (triangle,
/// line segment, or point) that is being generated by an
/// <tt>SoCallbackAction</tt>. It contains an object-space point, normal,
/// texture coordinates, material index, and a pointer to an instance of
/// an <tt>SoDetail</tt> subclass. This detail may contain more information
/// about the vertex, or may be a NULL pointer if there is no such info.
///
///
/// Instances of <tt>SoPrimitiveVertex</tt> are typically created on the stack
...
class SoPrimitiveVertex {
  ...
  public:
    ...
    /// Constructor. Note that copying a primitive vertex
