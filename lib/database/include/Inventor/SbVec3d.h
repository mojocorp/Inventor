...
class INVENTOR_API SbVec3d {
  public:
    ...
    /// Component-wise binary scalar multiplication operator
    friend INVENTOR_API SbVec3d	operator *(double d, const SbVec3d &v) { return v * d; }

    /// Component-wise binary scalar division operator
    friend INVENTOR_API SbVec3d	operator /(const SbVec3d &v, double d) { return v * (1.0f / d); }
    ...
    friend INVENTOR_API int		operator !=(const SbVec3d &v1, const SbVec3d &v2) { return !(v1 == v2); }
