...
//
char *SoQtExaminerViewer::geometryBuffer = "\
#Inventor V2.0 ascii\n\
\
Separator { \
...
static char *thisClassName = "SoQtExaminerViewer";
...
////////////////////////////////////////////////////////////////////////
{
    ...
    parent->addTab (createExamPrefSheetGuts(), tr("Seek"));
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    showRotPointToggle->setEnabled (camera != NULL);
    ...
    connect (feedbackWheel, SIGNAL (valueChanged(float)),
             this, SLOT (setFeedbackSizeWheelValue(float)));
    connect (feedbackWheel, SIGNAL (sliderPressed()),
             this, SLOT (interactiveCountInc()));
    connect (feedbackWheel, SIGNAL (sliderReleased()),
             this, SLOT (interactiveCountDec()));
    //-> SoQtFullViewer::feedbackSizeWheelCB
    hbox->addWidget (feedbackWheel);

    feedbackInput = new QSpinBox();
    feedbackInput->setRange (0, 1000);
    feedbackInput->setValue (value);
    connect (feedbackInput, SIGNAL (valueChanged(int)),
             this, SLOT (setFeedbackSize(int)));
...
void
SoQtExaminerViewer::setFeedbackSizeWheelValue (float value)
{
    // grow/shrink the feedback based on the wheel rotation
    setFeedbackSize ( feedbackSize *
                     pow (12.0, (value - feedbackSizeWheelVal) / 360.0));
    feedbackSizeWheelVal = value;
