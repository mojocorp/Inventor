...
class SOQT_EXPORT SoQtFullViewer : public SoQtViewer {
  ...
  public:
    ...
    //
    // Set a custom popup menu (TGS extension)
    //
    void setClientPopupMenu( QMenu* menu ) { clientPopup = menu; }
...
protected:
    ...
    virtual void    openStereoDialog(){} // TGS compat
    ...
    void            createSeekPrefSheetGuts(QTabWidget* parent);
    void            createSeekDistPrefSheetGuts(QTabWidget* parent);
    void            createZoomPrefSheetGuts(QTabWidget* parent);
    void            createClippingPrefSheetGuts(QTabWidget* parent);
    void            createStereoPrefSheetGuts(QTabWidget* parent);
    void            createSpeedPrefSheetGuts(QTabWidget* parent);
    ...
    SbPList        *viewerButtonWidgets; //TGS compat
...
private:
    ...
    Q_SLOT void setZoomSliderValue (int value);
    Q_SLOT void setAutoClippingState (int state);
    ...
    double          clipNearWheelVal, clipFarWheelVal;
	Q_SLOT void setClipNearWheelValue (float value);
    Q_SLOT void setClipFarWheelValue (float value);
    Q_SLOT void setClipNearValue (double value);
    Q_SLOT void setClipFarValue (double value);
	...
	double          stereoWheelVal;
    Q_SLOT void setStereoViewingValue (int state);
    Q_SLOT void setStereoWheelValue (float value);
    Q_SLOT void setStereoDistance (double value);
	
	// dolly speed pref sheet callbacks
    Q_SLOT void setSeekDistMode (int mode) { seekDistAsPercentage = (bool) mode; }
    Q_SLOT void setSeekDistWheelValue (float value);
	
    Q_SLOT void setZoomMinValue (double value);
    Q_SLOT void setZoomMaxValue (double value);
