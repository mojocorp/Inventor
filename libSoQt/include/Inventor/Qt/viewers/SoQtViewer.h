...
class SOQT_EXPORT SoQtViewer : public SoQtRenderArea {
  ...
  public:
    ...
    virtual void setPreserveCameraHeightAngle(SbBool flag) {} //TODO
    ...
    void setStereoViewType( SoBaseStereo* stereo ){} //TODO
    SoBaseStereo* getStereoViewType(){ return NULL; } //TODO
    SbBool isStereoViewReversed(){ return FALSE; } //TODO
    void reverseStereoView( SbBool reverse ){} //TODO
public slots:
    //
    // Camera routines.
    //
    ...
    float       getAutoClipTolerance () const { return autoClipTolerance; }
    ...
    virtual void    setStereoActive(SbBool activate) { setStereoViewing(activate); } // TGS compat
    virtual SbBool  isStereoActive() { return isStereoViewing(); } // TGS compat
    virtual void setStereoBalance( float balance, SbBool nearFrac = false ){} //TODO
    virtual float getStereoBalance() {  return 1.0f; } //TODO
    ...
    // on the viewer.
    virtual void    setNormalVisual(const QGLFormat & );
  ...
  protected:
    ...
    float		viewerSpeed; // default to 1.0 - SoQtFullViewer add UI to inc/dec
    ...
    SbBool	    processCommonEvents(QEvent *qe);
